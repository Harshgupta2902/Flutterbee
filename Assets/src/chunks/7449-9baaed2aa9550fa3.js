"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[7449], {
    5822: function(e, t, n) {
    ...
    7449: function(e, t, n) {
        ...
        let P = o.default.forwardRef(function(e, t) {
            let n, r;
            let {href: l, as: g, children: P, prefetch: v=null, passHref: _, replace: j, shallow: O, scroll: R, locale: M, onClick: x, onMouseEnter: C, onTouchStart: E, legacyBehavior: w=!1, ...k} = e;
            n = P,
            w && ("string" == typeof n || "number" == typeof n) && (n = o.default.createElement("a", null, n));
            let I = !1 !== v
            ...
            let H = {
                ...
                onClick(e) {
                    ...
                    A && !e.defaultPrevented && function(e, t, n, r, u, l, i, f, c, s) {
            ...
            i.isAbsoluteUrl)(W))
                ...
                p.getDomainLocale)(W, e, null == S ? void 0 : S.locales, null == S ? void 0 : S.domainLocales);
                H.href = t || (0,
                h.addBasePath)((0,
                f.addLocale)(W, e, null == S ? void 0 : S.defaultLocale))
            }
            return w ? o.default.cloneElement(r, H) : o.default.createElement("a", {
                ...k,
                ...H
            }, n)
        })
    ...
    2848: function(e, t, n) {
        ...
        function a(e) {
            ...
            e.host ? f = t + e.host : n && (f = t + (~n.indexOf(":") ? "[" + n + "]" : n),
            e.port && (f += ":" + e.port)),
            i && "object" == typeof i && (i = String(o.urlQueryToSearchParams(i)));
            let c = e.search || i && "?" + i || "";
            return r && !r.endsWith(":") && (r += ":"),
            e.slashes || (!r || u.test(r)) && !1 !== f ? (f = "//" + (f || ""),
            a && "/" !== a[0] && (a = "/" + a)) : f || (f = ""),
            l && "#" !== l[0] && (l = "#" + l),
            c && "?" !== c[0] && (c = "?" + c),
            "" + r + f + (a = a.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace("#", "%23")) + l
        }
    ...
    4823: function(e, t, n) {
        ...
        function u(e, t, n) {
            ...
            return f.every(e=>{
                ...
                (r || e in i) && (u = u.replace(o, n ? t.map(e=>encodeURIComponent(e)).join("/") : encodeURIComponent(t)) || "/")
            }
            ) || (u = ""),
            {
                params: f,
    ...
    1766: function(e, t, n) {
        ...
        function s(e, t, n) {
            ...
            try {
                ...
                let t = "";
                if ((0,
                f.isDynamicRoute)(e.pathname) && e.searchParams && n) {
                    let n = (0,
            ...
            return {
                namedParameterizedRoute: i.map(e=>{
                        ...
                        r.escapeStringRegexp)(e);
                    {
                        ...
                        t && (l = "" + u + l);
                        let i = !1;
                        return (0 === l.length || l.length > 30) && (i = !0),
                        isNaN(parseInt(l.slice(0, 1))) || (i = !0),
                        i && (l = f()),
                        t ? c[l] = "" + u + n : c[l] = "" + n,
                        o ? r ? "(?:/(?<" + l + ">.+?))?" : "/(?<" + l + ">.+?)" : "/(?<" + l + ">[^/]+?)"
                    }
