"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3631], {
    6470: function(t, e, i) {
        let s;
        i.d(e, {
            $1: function() {
        ...
        var o, n, r, l = i(4091), h = i(5227), a = i(9372);
        function c(t) {
        ...
        function m(t, e, i, s, o) {
            for (; ; ) {
                ...
                if (e == (o < 0 ? 0 : v(t))) {
                    ...
                    if (1 != t.nodeType || 1 == (t = t.childNodes[e + (o < 0 ? -1 : 0)]).nodeType && "false" == t.contentEditable)
                        return !1;
                    e = o < 0 ? v(t) : 0
                }
            }
        ...
        function x(t) {
            ...
            if (y)
                return t.focus(y);
            let e = [];
            for (let i = t; i && (e.push(i, i.scrollTop, i.scrollLeft),
            i != i.ownerDocument); i = i.parentNode)
                ;
            if (t.focus(null == y ? {
                get preventScroll() {
                    return y = {
        ...
        class C {
            ...
            static before(t, e) {
                return new C(t.parentNode,g(t),e)
            }
            static after(t, e) {
                return new C(t.parentNode,g(t) + 1,e)
            }
        }
        let D = [];
        class A {
            ...
            sync(t, e) {
                if (2 & this.dirty) {
                    ...
                    for (let n of this.children) {
                        ...
                        if (o = s ? s.nextSibling : i.firstChild,
                        e && !e.written && e.node == i && o != n.dom && (e.written = !0),
                        n.dom.parentNode == i)
                            for (; o && o != n.dom; )
                                o = T(o);
                        else
                    ...
                    for ((o = s ? s.nextSibling : i.firstChild) && e && e.node == i && (e.written = !0); o; )
                        o = T(o)
            ...
            localPosFromDOM(t, e) {
                ...
                if (t == this.dom)
                    ...
                    for (; ; ) {
                        ...
                        if (e == this.dom)
                            break;
                        0 == s && e.firstChild != e.lastChild && (s = t == e.firstChild ? -1 : 1),
                        t = e
                    }
            ...
            domBoundsAround(t, e, i=0) {
                ...
                for (let l = 0, h = i, a = i; l < this.children.length; l++) {
                    let i = this.children[l]
                      , c = h + i.length;
                    if (h < t && c > e)
                        return i.domBoundsAround(t, e, h);
                    if (c >= t && -1 == s && (s = l,
                    o = h),
            ...
            childCursor(t=this.length) {
                return new O(this.children,t,this.children.length)
            }
            childPos(t, e=1) {
        ...
        function R(t, e, i, s, o, n, r, l, h) {
            ...
            if (!(e == s && c && !r && !u && n.length < 2 && c.merge(i, o, n.length ? d : null, 0 == i, l, h))) {
                if (s < a.length) {
                    let t = a[s];
                    t && o < t.length ? (e == s && (t = t.split(o),
                    o = 0),
                    !u && d && t.merge(0, o, d, !0, 0, h) ? n[n.length - 1] = t : (o && t.merge(0, o, null, !1, 0, h),
                    n.push(t))) : (null == t ? void 0 : t.breakAfter) && (d ? d.breakAfter = 1 : r = 1),
                    s++
                }
                for (c && (c.breakAfter = r,
                i > 0 && (!r && n.length && c.merge(i, c.length, n[0], !1, l, 0) ? c.breakAfter = n.shift().breakAfter : (i < c.length || c.children.length && 0 == c.children[c.children.length - 1].length) && c.merge(i, c.length, null, !1, l, 0),
                e++)); e < s && n.length; )
                    if (a[s - 1].become(n[n.length - 1]))
                        s--,
                        n.pop(),
                        h = n.length ? 0 : l;
                    else if (a[e].become(n[0]))
                        e++,
                        n.shift(),
                        l = n.length ? 0 : h;
                    else
                        break;
                !n.length && e && s < a.length && !a[e - 1].breakAfter && a[s].merge(0, 0, a[e - 1], !1, l, h) && e--,
        ...
        let B = "undefined" != typeof navigator ? navigator : {
            userAgent: "",
            vendor: "",
            platform: ""
        }
          ...
          , H = /Edge\/(\d+)/.exec(B.userAgent)
          , V = /MSIE \d/.test(B.userAgent)
          , P = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(B.userAgent)
          , N = !!(V || P || H)
          , W = !N && /gecko\/(\d+)/i.test(B.userAgent)
          , z = !N && /Chrome\/(\d+)/.exec(B.userAgent)
          , F = "webkitFontSmoothing"in L.documentElement.style
          , I = !N && /Apple Computer/.test(B.vendor)
          , q = I && (/Mobile\/\w+/.test(B.userAgent) || B.maxTouchPoints > 2);
        var K = {
            mac: q || /Mac/.test(B.platform),
            windows: /Win/.test(B.platform),
            linux: /Linux|X11/.test(B.platform),
            ie: N,
            ie_version: V ? L.documentMode || 6 : P ? +P[1] : H ? +H[1] : 0,
            gecko: W,
            gecko_version: W ? +(/Firefox\/(\d+)/.exec(B.userAgent) || [0, 0])[1] : 0,
            chrome: !!z,
            ...
            webkit: F,
            safari: I,
            webkit_version: F ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0,
            tabSize: null != L.documentElement.style.tabSize ? "tab-size" : "-moz-tab-size"
        };
        class j extends A {
            constructor(t) {
                super(),
            ...
            merge(t, e, i) {
                return (!i || i instanceof j && !(this.length - (e - t) + i.length > 256)) && (this.text = this.text.slice(0, t) + (i ? i.text : "") + this.text.slice(e),
                this.markDirty(),
                !0)
            }
            split(t) {
                let e = new j(this.text.slice(t));
        ...
        class $ extends A {
            ...
            sync(t, e) {
                this.dom ? 4 & this.dirty && this.setAttrs(this.dom) : this.setDOM(this.setAttrs(document.createElement(this.mark.tagName))),
                super.sync(t, e)
            }
            merge(t, e, i, s, o, n) {
                return (!i || !!(i instanceof $ && i.mark.eq(this.mark)) && (!t || !(o <= 0)) && (!(e < this.length) || !(n <= 0))) && (E(this, t, e, i ? i.children : [], o - 1, n - 1),
                this.markDirty(),
                !0)
            }
            split(t) {
        ...
        function G(t, e, i) {
            ...
            let o = e
              , n = e
              , r = 0;
            0 == e && i < 0 || e == s && i >= 0 ? !(K.chrome || K.gecko) && (e ? (o--,
            r = 1) : n < s && (n++,
            r = -1)) : i < 0 ? o-- : n < s && n++;
            ...
            return K.safari && !r && 0 == h.width && (h = Array.prototype.find.call(l, t=>t.width) || h),
            r ? w(h, r < 0) : h || null
        }
        class X extends A {
            constructor(t, e, i) {
            ...
            merge(t, e, i, s, o, n) {
                return (!i || i instanceof X && !!this.widget.compare(i.widget) && (!(t > 0) || !(o <= 0)) && (!(e < this.length) || !(n <= 0))) && (this.length = t + (i ? i.length : 0) + (this.length - e),
                !0)
            }
            become(t) {
                return t instanceof X && t.side == this.side && this.widget.constructor == t.widget.constructor && (this.widget.compare(t.widget) || this.markDirty(!0),
            ...
            domAtPos(t) {
                return (this.length ? 0 == t : this.side > 0) ? C.before(this.dom) : C.after(this.dom, t == this.length)
            }
            domBoundsAround() {
                return null
            }
            coordsAt(t, e) {
                ...
                if (!s.length)
                    return null;
                for (let e = t > 0 ? s.length - 1 : 0; o = s[e],
                t > 0 ? 0 != e : e != s.length - 1 && !(o.top < o.bottom); e += t > 0 ? -1 : 1)
                    ;
                return this.length ? o : w(o, this.side > 0)
            }
            get isEditable() {
                return !1
            }
        ...
        class _ extends X {
            domAtPos(t) {
                ...
                return e ? Y(t, 0, e, i, this.length - e.length, (t,e)=>t.domAtPos(e), (t,e)=>new C(t,Math.min(e, t.nodeValue.length))) : new C(i,Math.min(t, i.nodeValue.length))
            }
            sync() {
            ...
            localPosFromDOM(t, e) {
                ...
                return i ? function t(e, i, s, o, n) {
                    if (s instanceof $) {
                        let r = 0;
                        for (let l = s.dom.firstChild; l; l = l.nextSibling) {
                            let s = A.get(l);
                            if (s) {
                                let h = d(l, o);
                                if (d(l, e))
                                    return r + (h ? t(e, i, s, o, n) : s.localPosFromDOM(e, i));
                                r += s.length + (h ? n : 0)
                            } else {
                                let t = function t(e, i, s) {
                                    ...
                                    {
                                        let o = 0;
                                        for (let n = s.firstChild, r = 0; ; n = n.nextSibling,
                                        r++) {
                                            if (e == s && r == i)
                                                return {
                                                    result: o
                        ...
                        return Math.min(i, o.nodeValue.length);
                    return s.localPosFromDOM(e, i)
                }(t, e, i, s, this.length - i.length) : Math.min(e, this.length)
            }
            ignoreMutation() {
                return !1
            }
            ...
            coordsAt(t, e) {
                let {topView: i, text: s} = this.widget;
                return i ? Y(t, e, i, s, this.length - i.length, (t,e,i)=>t.coordsAt(e, i), (t,e,i)=>G(t, e, i)) : G(s, t, e)
            }
            destroy() {
                var t;
                super.destroy(),
        ...
        function Y(t, e, i, s, o, n, r) {
            if (i instanceof $) {
                for (let l = i.dom.firstChild; l; l = l.nextSibling) {
                    ...
                    if (i) {
                        let h = d(l, s)
                          , a = i.length + (h ? o : 0);
                        if (t < a || t == a && 0 >= i.getSide())
                            return h ? Y(t, e, i, s, o, n, r) : n(i, t, e);
                        t -= a
                    } else {
                        let i = function t(e, i, s, o) {
                            if (3 == s.nodeType) {
                                let t = s.nodeValue.length;
                                if (e <= t)
                                    return o(s, e, i);
                                e -= t
                            } else if (1 == s.nodeType && "false" != s.contentEditable)
            ...
            return i.dom == s ? r(s, t, e) : n(i, t, e)
        }
        class U extends A {
            constructor(t) {
                super(),
            ...
            domAtPos(t) {
                return this.side > 0 ? C.before(this.dom) : C.after(this.dom)
            }
            localPosFromDOM() {
                return 0
            }
        ...
        function Z(t, e, i) {
            ...
            !function t(e, l) {
                for (let h = 0, a = 0; h < e.children.length && a <= l; h++) {
                    let c = e.children[h]
                      , d = a + c.length;
                    d >= l && (c.children.length ? t(c, l - a) : (!n || n.isHidden && i > 0) && (d > l || a == d && c.getSide() > 0) ? (n = c,
                    r = l - a) : (a < l || a == d && 0 > c.getSide() && !c.isHidden) && (s = c,
                    o = l - a)),
                    a = d
                }
            }(t, e);
        ...
        function J(t, e) {
            for (let i in t)
                "class" == i && e.class ? e.class += " " + t.class : "style" == i && e.style ? e.style += ";" + t.style : e[i] = t[i];
            return e
        }
        function tt(t, e) {
            if (t == e)
        ...
        function te(t, e, i) {
            ...
            if (e)
                for (let o in e)
                    i && o in i || t.removeAttribute(s = o);
            if (i)
                for (let o in i)
                    e && e[o] == i[o] || t.setAttribute(s = o, i[o]);
            return !!s
        }
        j.prototype.children = X.prototype.children = U.prototype.children = D;
        class ti {
            eq(t) {
                return !1
            }
        ...
        class to extends l.uU {
            ...
            static widget(t) {
                let e = t.side || 0
                  , i = !!t.block;
                return e += i ? e > 0 ? 3e8 : -4e8 : e > 0 ? 1e8 : -1e8,
                new tl(t,e,e,i,t.widget || null,!1)
            }
            static replace(t) {
                let e = !!t.block, i, s;
                if (t.isBlockGap)
                    ...
                    let {start: o, end: n} = th(t, e);
                    i = (o ? e ? -3e8 : -1 : 5e8) - 1,
                    s = (n ? e ? 2e8 : 1 : -6e8) + 1
                }
                return new tl(t,i,s,e,t.widget || null,!0)
            }
            static line(t) {
                return new tr(t)
            }
        ...
        class tn extends to {
            ...
            eq(t) {
                return this == t || t instanceof tn && this.tagName == t.tagName && this.class == t.class && tt(this.attrs, t.attrs)
            }
            range(t, e=t) {
                if (t >= e)
        ...
        class tr extends to {
            ...
            eq(t) {
                return t instanceof tr && this.spec.class == t.spec.class && tt(this.spec.attributes, t.spec.attributes)
            }
            range(t, e=t) {
                if (e != t)
        ...
        tr.prototype.mapMode = l.gc.TrackBefore,
        ...
        class tl extends to {
            constructor(t, e, i, s, o, n) {
                ...
                this.block = s,
                this.isReplace = n,
                this.mapMode = s ? e <= 0 ? l.gc.TrackBefore : l.gc.TrackAfter : l.gc.TrackDel
            }
            get type() {
                return this.startSide < this.endSide ? ts.WidgetRange : this.startSide <= 0 ? ts.WidgetBefore : ts.WidgetAfter
            }
            get heightRelevant() {
            ...
            eq(t) {
                var e, i;
                return t instanceof tl && ((e = this.widget) == (i = t.widget) || !!(e && i && e.compare(i))) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide
            }
            range(t, e=t) {
        ...
        class tc extends A {
            ...
            setDeco(t) {
                tt(this.attrs, t) || (this.dom && (this.prevAttrs = this.attrs,
                this.markDirty()),
                this.attrs = t)
            }
            append(t, e) {
                !function t(e, i, s) {
                    let o, {children: n} = e;
                    s > 0 && i instanceof $ && n.length && (o = n[n.length - 1])instanceof $ && o.mark.eq(i.mark) ? t(o, i.children[0], s - 1) : (n.push(i),
                    i.setParent(e)),
                    e.length += i.length
                }(this, t, e)
            }
            ...
            reuseDOM(t) {
                "DIV" == t.nodeName && (this.setDOM(t),
                this.dirty |= 6)
            }
            sync(t, e) {
                var i;
                this.dom ? 4 & this.dirty && (k(this.dom),
                this.dom.className = "cm-line",
                this.prevAttrs = this.attrs ? null : void 0) : (this.setDOM(document.createElement("div")),
                this.dom.className = "cm-line",
                this.prevAttrs = this.attrs ? null : void 0),
                void 0 !== this.prevAttrs && (te(this.dom, this.prevAttrs, this.attrs),
                this.dom.classList.add("cm-line"),
                this.prevAttrs = void 0),
                super.sync(t, e);
                let s = this.dom.lastChild;
                for (; s && A.get(s)instanceof $; )
                    s = s.lastChild;
                if (!s || !this.length || "BR" != s.nodeName && (null === (i = A.get(s)) || void 0 === i ? void 0 : i.isEditable) == !1 && (!K.ios || !this.children.some(t=>t instanceof j))) {
        ...
        class td extends A {
            ...
            merge(t, e, i, s, o, n) {
                return (!i || i instanceof td && !!this.widget.compare(i.widget) && (!(t > 0) || !(o <= 0)) && (!(e < this.length) || !(n <= 0))) && (this.length = t + (i ? i.length : 0) + (this.length - e),
                !0)
            }
            domAtPos(t) {
            ...
            split(t) {
                let e = this.length - t;
                this.length = t;
                let i = new td(this.widget,e,this.type);
            ...
            become(t) {
                return t instanceof td && t.type == this.type && t.widget.constructor == this.widget.constructor && (t.widget.compare(this.widget) || this.markDirty(!0),
                this.dom && !this.prevWidget && (this.prevWidget = this.widget),
                this.widget = t.widget,
                this.length = t.length,
        ...
        class tu {
            ...
            posCovered() {
                ...
                return !t.breakAfter && !(t instanceof td && t.type == ts.WidgetBefore)
            }
            getLine() {
                return this.curLine || (this.content.push(this.curLine = new tc),
                this.atCursorPos = !0),
                this.curLine
            }
            flushBuffer(t=this.bufferMarks) {
                this.pendingBuffer && (this.curLine.append(tf(new U(-1), t), t.length),
                this.pendingBuffer = 0)
            }
            addBlockWidget(t) {
                this.flushBuffer(),
            ...
            buildText(t, e, i) {
                for (; t > 0; ) {
                    ...
                    this.getLine().append(tf(new j(this.text.slice(this.textOff, this.textOff + s)), e), i),
                    this.atCursorPos = !0,
                    this.textOff += s,
                    t -= s,
                    i = 0
            ...
            point(t, e, i, s, o, n) {
                if (this.disallowBlockEffectsFor[n] && i instanceof tl) {
                    if (i.block)
                ...
                if (i instanceof tl) {
                    if (i.block) {
                        let {type: t} = i;
                        t != ts.WidgetAfter || this.posCovered() || this.getLine(),
                        this.addBlockWidget(new td(i.widget || new tp("div"),r,t))
                    } else {
                        let n = X.create(i.widget || new tp("span"), r, r ? 0 : i.startSide)
                          , l = this.atCursorPos && !n.isEditable && o <= s.length && (t < e || i.startSide > 0)
                          , h = !n.isEditable && (t < e || o > s.length || i.startSide <= 0)
                          , a = this.getLine();
                        2 != this.pendingBuffer || l || n.isEditable || (this.pendingBuffer = 0),
                        this.flushBuffer(s),
                        l && (a.append(tf(new U(1), s), o),
                ...
                r && (this.textOff + r <= this.text.length ? this.textOff += r : (this.skip += r - (this.text.length - this.textOff),
                this.text = "",
                this.textOff = 0),
                this.pos = e),
            ...
            static build(t, e, i, s, o) {
                let n = new tu(t,e,i,o);
                return n.openEnd = l.Xs.spans(s, e, i, n),
        ...
        class tk {
            ...
            map(t) {
                return t.empty ? this : new tk(this.range.map(t),this.y,this.x,this.yMargin,this.xMargin)
            }
        }
        let tC = l.Py.define({
            map: (t,e)=>t.map(e)
        ...
        class tR {
            ...
            static define(t, e) {
                ...
                return new tR(tT++,t,i,t=>{
                    let e = [tO.of(t)];
                    return o && e.push(tH.of(e=>{
                        let i = e.plugin(t);
                        return i ? o(i) : to.none
                    }
                    )),
                    s && e.push(s(t)),
                    e
                    ...
                    if (this.mustUpdate) {
                        ...
                        this.value.update)
                            try {
                                ...
                                if (tD(t.state, e, "CodeMirror plugin crashed"),
                                this.value.destroy)
                                    try {
                                        this.value.destroy()
                                    } catch (t) {}
        ...
        class tW {
            ...
            join(t) {
                return new tW(Math.min(this.fromA, t.fromA),Math.max(this.toA, t.toA),Math.min(this.fromB, t.fromB),Math.max(this.toB, t.toB))
            }
            addToSet(t) {
                let e = t.length
                  , i = this;
                ...
                for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
                    ...
                    for (; o < e.length && e[o] < a; ) {
                        let t = e[o]
                          ...
                          , n = Math.max(r, t)
                          , l = Math.min(a, s);
                        if (n <= l && new tW(n + h,l + h,n,l).addToSet(i),
                        s > a)
                            break;
                        o += 2
                    }
                    if (!l)
                        return i;
                    new tW(l.fromA,l.toA,l.fromB,l.toB).addToSet(i),
                    n = l.toA,
                    r = l.toB
                }
            }
        ...
        class tz {
            constructor(t, e, i) {
                ...
                let s = [];
                this.changes.iterChangedRanges((t,e,i,o)=>s.push(new tW(t,e,i,o))),
        ...
        let tj = tK("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008")
          , t$ = tK("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333")
        ...
        class tJ {
            ...
            readRange(t, e) {
                ...
                for (let s = t; ; ) {
                    ...
                    let o = A.get(s)
                      , n = A.get(t);
                    (o && n ? o.breakAfter : (o ? o.breakAfter : t0(s)) || t0(t) && ("BR" != s.nodeName || s.cmIgnore)) && this.lineBreak(),
                    s = t
                }
            ...
            readTextNode(t) {
                ...
                for (let i = 0, s = this.lineSeparator ? null : /\r\n?|\n/g; ; ) {
                    let o = -1, n = 1, r;
                    if (this.lineSeparator ? (o = e.indexOf(this.lineSeparator, i),
                    n = this.lineSeparator.length) : (r = s.exec(e)) && (o = r.index,
                    n = r[0].length),
            ...
            readNode(t) {
                ...
                if (null != i) {
                    ...
                    3 == t.nodeType ? this.readTextNode(t) : "BR" == t.nodeName ? t.nextSibling && this.lineBreak() : 1 == t.nodeType && this.readRange(t.firstChild, null)
            }
            findPointBefore(t, e) {
                for (let i of this.points)
        ...
        class t2 extends A {
            constructor(t) {
                ...
                this.children = [new tc],
                this.children[0].setParent(this),
                this.updateDeco(),
                this.updateInner([new tW(0,0,0,t.state.doc.length)], 0)
            }
            get length() {
            ...
            update(t) {
                ...
                this.minWidth > 0 && n.length && (n.every(({fromA: t, toA: e})=>e < this.minWidthFrom || t > this.minWidthTo) ? (this.minWidthFrom = t.changes.mapPos(this.minWidthFrom, 1),
                this.minWidthTo = t.changes.mapPos(this.minWidthTo, 1)) : this.minWidth = this.minWidthFrom = this.minWidthTo = 0),
                this.view.inputState.composing < 0 ? this.compositionDeco = to.none : (t.transactions.length || this.dirty) && (this.compositionDeco = function(t, e) {
                    let i = t3(t);
                    if (!i)
                        return to.none;
                    let {from: s, to: o, node: n, text: r} = i
                      ...
                      , {state: a} = t
                      , c = 3 == n.nodeType ? n.nodeValue : new tJ([],a).readRange(n.firstChild, null).text;
                    if (h - l < c.length) {
                        if (a.doc.sliceString(l, Math.min(a.doc.length, l + c.length), "￿") == c)
                            h = l + c.length;
                        else {
                    ...
                    } else if (a.doc.sliceString(l, h, "￿") != c)
                        return to.none;
                    let d = A.get(n);
                    return d instanceof _ ? d = d.widget.topView : d && (d.parent = null),
                    to.set(to.replace({
                        widget: new t9(n,r,d),
                        inclusive: !0
                    }).range(l, h))
                }(this.view, t.changes)),
                (K.ie || K.chrome) && !this.compositionDeco.size && t && t.state.doc.lines != t.startState.doc.lines && (this.forceSelection = !0);
                let r = (e = this.decorations,
                i = this.updateDeco(),
                s = t.changes,
                o = new t4,
                l.Xs.compare(e, i, s, o),
                o.changes);
                return n = tW.extendWithRanges(n, r),
                (0 != this.dirty || 0 != n.length) && (this.updateInner(n, t.startState.doc.length),
            ...
            updateInner(t, e) {
                ...
                if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
                    for (let t of this.children)
                        t instanceof td && t.widget instanceof t8 && s.push(t.dom);
                i.updateGaps(s)
            }
            updateChildren(t, e) {
                ...
                for (let e = t.length - 1; ; e--) {
                    ...
                    let {fromA: o, toA: n, fromB: r, toB: l} = s
                      , {content: h, breakAtStart: a, openStart: c, openEnd: d} = tu.build(this.view.state.doc, r, l, this.decorations, this.dynamicDecorationMap)
            ...
            updateSelection(t=!1, e=!1) {
                ...
                if (K.gecko && l.empty && !this.compositionDeco.size && 1 == (i = h).node.nodeType && i.node.firstChild && (0 == i.offset || "false" == i.node.childNodes[i.offset - 1].contentEditable) && (i.offset == i.node.childNodes.length || "false" == i.node.childNodes[i.offset].contentEditable)) {
                    let t = document.createTextNode("");
                    this.view.observer.ignore(()=>h.node.insertBefore(t, h.node.childNodes[h.offset] || null)),
                    h = a = new C(t,0),
                    r = !0
                }
                ...
                !r && d.focusNode && p(h.node, h.offset, d.anchorNode, d.anchorOffset) && p(a.node, a.offset, d.focusNode, d.focusOffset) || (this.view.observer.ignore(()=>{
                    K.android && K.chrome && this.dom.contains(d.focusNode) && function(t, e) {
                        for (let i = t; i && i != e; i = i.assignedSlot || i.parentNode)
                            if (1 == i.nodeType && "false" == i.contentEditable)
                                return !0;
                        return !1
                    }(d.focusNode, this.dom) && (this.dom.blur(),
                    this.dom.focus({
                        preventScroll: !0
                    }));
                    ...
                    if (t) {
                        if (l.empty) {
                            if (K.gecko) {
                                ...
                                let t = (e = h.node,
                                i = h.offset,
                                1 != e.nodeType ? 0 : (i && "false" == e.childNodes[i - 1].contentEditable ? 1 : 0) | (i < e.childNodes.length && "false" == e.childNodes[i].contentEditable ? 2 : 0));
                                if (t && 3 != t) {
                                    let e = t5(h.node, h.offset, 1 == t ? 1 : -1);
                                    e && (h = new C(e,1 == t ? 0 : e.nodeValue.length))
                                }
                            }
                            t.collapse(h.node, h.offset),
                            null != l.bidiLevel && null != d.cursorBidiLevel && (d.cursorBidiLevel = l.bidiLevel)
                        } else if (t.extend) {
                            t.collapse(h.node, h.offset);
                            try {
                    ...
                    n && this.view.root.activeElement == this.dom && (this.dom.blur(),
                    s && s.focus())
                }
                ),
                this.view.observer.setSelectionRange(h, a)),
                this.impreciseAnchor = h.precise ? null : new C(d.anchorNode,d.anchorOffset),
                this.impreciseHead = a.precise ? null : new C(d.focusNode,d.focusOffset)
            }
            enforceCursorAssoc() {
            ...
            coordsAt(t, e) {
                for (let i = this.length, s = this.children.length - 1; ; s--) {
                    ...
                    if (t > n || t == n && o.type != ts.WidgetBefore && o.type != ts.WidgetAfter && (!s || 2 == e || this.children[s - 1].breakAfter || this.children[s - 1].type == ts.WidgetBefore && e > -2))
            ...
            measureVisibleLineHeights(t) {
                let e = []
                  ...
                  , r = -1
                  , l = this.view.textDirection == tF.LTR;
            ...
            textDirectionAt(t) {
                ...
                return "rtl" == getComputedStyle(this.children[e].dom).direction ? tF.RTL : tF.LTR
            }
            measureTextSize() {
                for (let t of this.children)
                    if (t instanceof tc) {
            ...
            updateDeco() {
                let t = this.view.state.facet(tH).map((t,e)=>(this.dynamicDecorationMap[e] = "function" == typeof t) ? t(this.view) : t);
                for (let e = t.length; e < t.length + 3; e++)
                    this.dynamicDecorationMap[e] = !1;
                return this.decorations = [...t, this.compositionDeco, this.computeBlockGapDeco(), this.view.viewState.lineGapDeco]
            }
            scrollIntoView(t) {
                    ...
                    for (let c = t; c; )
                        if (1 == c.nodeType) {
                            ...
                            let u = 0
                              , f = 0;
                            if ("nearest" == o)
                                e.top < t.top ? (f = -(t.top - e.top + r),
                                i > 0 && e.bottom > t.bottom + f && (f = e.bottom - t.bottom + f + r)) : e.bottom > t.bottom && (f = e.bottom - t.bottom + r,
                                i < 0 && e.top - f < t.top && (f = -(t.top + f - e.top + r)));
                            else {
                                let s = e.bottom - e.top
                                  , n = t.bottom - t.top;
                                f = ("center" == o && s <= n ? e.top + s / 2 - n / 2 : "start" == o || "center" == o && i < 0 ? e.top - r : e.bottom - n + r) - t.top
                            }
                            if ("nearest" == s ? e.left < t.left ? (u = -(t.left - e.left + n),
                            i > 0 && e.right > t.right + u && (u = e.right - t.right + u + n)) : e.right > t.right && (u = e.right - t.right + n,
                            i < 0 && e.left < t.left + u && (u = -(t.left + u - e.left + n))) : u = ("center" == s ? e.left + (e.right - e.left) / 2 - (t.right - t.left) / 2 : "start" == s == l ? e.left - n : e.right - (t.right - t.left) + n) - t.left,
                            u || f) {
                                if (d)
                                    a.scrollBy(u, f);
                                else {
                            ...
                            if (d)
                                break;
                            c = c.assignedSlot || c.parentNode
                        } else if (11 == c.nodeType)
                            c = c.host;
                        else
                            break
                }(this.view.scrollDOM, h, e.head < e.anchor ? -1 : 1, t.x, t.y, t.xMargin, t.yMargin, this.view.textDirection == tF.LTR)
            }
        }
        class t8 extends ti {
            constructor(t) {
        ...
        function t3(t) {
            let e = t.observer.selectionRange
              , i = e.focusNode && t5(e.focusNode, e.focusOffset, 0);
            if (!i)
                return null;
            ...
            if (s instanceof tc) {
                let t = i;
                for (; t.parentNode != s.dom; )
                    t = t.parentNode;
                let e = t.previousSibling;
                for (; e && !A.get(e); )
                    e = e.previousSibling;
                let o = e ? A.get(e).posAtEnd : s.posAtStart;
                return {
                    from: o,
                    to: o,
                    node: t,
                ...
                for (let h = 0; h < s.length; h++) {
                    ...
                    if (a.left - 1 <= e && a.right + 1 >= e && c < n) {
                        let i = e >= (a.left + a.right) / 2
                          , s = i;
                        if ((K.chrome || K.gecko) && S(t, l).getBoundingClientRect().left == a.right && (s = !i),
                        c <= 0)
                            return {
                                node: t,
                                offset: l + (s ? 1 : 0)
        ...
        function ei(t, e, i, s=-1) {
            var o, n;
            let r = t.contentDOM.getBoundingClientRect(), l = r.top + t.viewState.paddingTop, h, {docHeight: a} = t.viewState, {x: c, y: d} = e, u = d - l;
            if (u < 0)
                return 0;
            if (u > a)
                return t.state.doc.length;
            for (let e = t.defaultLineHeight / 2, o = !1; (h = t.elementAtHeight(u)).type != ts.Text; )
            ...
            if (p < t.viewport.from)
                return 0 == t.viewport.from ? 0 : i ? null : es(t, r, h, c, d);
            if (p > t.viewport.to)
                return t.viewport.to == t.state.doc.length ? t.state.doc.length : i ? null : es(t, r, h, c, d);
            let g = t.dom.ownerDocument
              , m = t.root.elementFromPoint ? t.root : g
              , v = m.elementFromPoint(c, d);
            v && !t.contentDOM.contains(v) && (v = null),
            !v && (c = Math.max(r.left + 1, Math.min(r.right - 1, c)),
            (v = m.elementFromPoint(c, d)) && !t.contentDOM.contains(v) && (v = null));
            let w, b = -1;
            if (v && (null === (o = t.docView.nearest(v)) || void 0 === o ? void 0 : o.isEditable) != !1) {
                if (g.caretPositionFromPoint) {
                    ...
                    e && ({startContainer: w, startOffset: b} = e,
                    (!t.contentDOM.contains(w) || K.safari && function(t, e, i) {
                        let s;
                        ...
                        for (let e = t; ; ) {
                            ...
                            if (!t || 1 != t.nodeType || t.firstChild != e)
                                return !1;
                            if (t.classList.contains("cm-line"))
                                break;
                            e = t
                        }
                ...
                ({node: w, offset: b} = function t(e, i, s) {
                    ...
                    for (let m = e.firstChild; m; m = m.nextSibling) {
                        ...
                        for (let f = 0; f < e.length; f++) {
                            ...
                            0 == w ? s > v.bottom && (!r || r.bottom < v.bottom) ? (o = m,
                            r = v) : s < v.top && (!l || l.top > v.top) && (n = m,
                            l = v) : r && t6(r, v) ? r = et(r, v.bottom) : l && t6(l, v) && (l = t7(l, v.top))
                        }
                    }
                    if (r && r.bottom >= s ? (h = o,
                    a = r) : l && l.top <= s && (h = n,
            ...
            if (!y)
                return null;
            if (!y.isWidget || (null === (n = y.dom) || void 0 === n ? void 0 : n.nodeType) != 1)
        ...
        function es(t, e, i, s, o) {
            let n = Math.round((s - e.left) * t.defaultCharacterWidth);
            t.lineWrapping && i.height > 1.5 * t.defaultLineHeight && (n += Math.floor((o - i.top) / t.defaultLineHeight) * t.viewState.heightOracle.lineLength);
            let r = t.state.sliceDoc(i.from, i.to);
            return i.from + (0,
            l.Gz)(r, n, t.state.tabSize)
        }
        function eo(t, e, i, s) {
            ...
            for (let h = e, a = null; ; ) {
                let e = function(t, e, i, s, o) {
                    ...
                    if (0 == r) {
                        if (!o || !t.length)
                            return null;
                        e[0].level != i && (r = e[0].side(!1, i),
                        h = 0)
                    } else if (r == t.length) {
                        if (o)
                            return null;
                        let t = e[e.length - 1];
                        t.level != i && (r = t.side(!0, i),
                        h = e.length - 1)
                    }
                    h < 0 && (h = tY.find(e, r, null !== (n = s.bidiLevel) && void 0 !== n ? n : -1, s.assoc));
                    let a = e[h];
                    r == a.side(o, i) && (r = (a = e[h += o ? 1 : -1]).side(!o, i));
                    let c = o == (a.dir == i)
                      , d = (0,
                    l.cp)(t.text, r, c);
                    if (tZ = t.text.slice(Math.min(r, d), Math.max(r, d)),
                    d != a.side(o, i))
        ...
        function en(t, e, i) {
            let s = t.state.facet(tV).map(e=>e(t));
            for (; ; ) {
                let t = !1;
                for (let o of s)
                    o.between(i.from - 1, i.from + 1, (s,o,n)=>{
                        i.from > s && i.from < o && (i = e.head > i.from ? l.jT.cursor(s, 1) : l.jT.cursor(o, -1),
                        t = !0)
                    }
                    );
                if (!t)
        ...
        class er {
            constructor(t) {
                ...
                let e = (e,i)=>{
                    !this.ignoreDuringComposition(i) && ("keydown" == i.type && this.keydown(t, i) || (this.mustFlushObserver(i) && t.observer.forceFlush(),
                    this.runCustomHandlers(i.type, t, i) ? i.preventDefault() : e(t, i)))
                }
                ;
                for (let i in ef) {
                    let s = ef[i];
                ...
                t.scrollDOM.addEventListener("mousedown", i=>{
                    if (i.target == t.scrollDOM && i.clientY > t.contentDOM.getBoundingClientRect().bottom && (e(ef.mousedown, i),
                    !i.defaultPrevented && 2 == i.button)) {
                ...
                t.scrollDOM.addEventListener("drop", i=>{
                    i.target == t.scrollDOM && i.clientY > t.contentDOM.getBoundingClientRect().bottom && e(ef.drop, i)
                }
                ),
                K.chrome && 102 == K.chrome_version && t.scrollDOM.addEventListener("wheel", ()=>{
                    this.chromeScrollHack < 0 ? t.contentDOM.style.pointerEvents = "none" : window.clearTimeout(this.chromeScrollHack),
                ...
                K.safari && t.contentDOM.addEventListener("input", ()=>null)
            }
            ...
            ensureHandlers(t, e) {
                ...
                e))
                    if (s = null === (i = o.update(t).spec) || void 0 === i ? void 0 : i.domEventHandlers)
                        ...
                        s)
                            0 > this.registeredEvents.indexOf(e) && "scroll" != e && (this.registeredEvents.push(e),
                            t.contentDOM.addEventListener(e, i=>{
                                eu(t, i) && this.runCustomHandlers(e, t, i) && i.preventDefault()
                            }
                            ))
            }
            runCustomHandlers(t, e, i) {
                for (let s of this.customHandlers) {
                    ...
                    if (o)
                        try {
                            if (o.call(s.plugin, i, e) || i.defaultPrevented)
                                return !0
                        } catch (t) {
                            tD(e.state, t)
                        }
            ...
            keydown(t, e) {
                ...
                !!(9 == e.keyCode && Date.now() < this.lastEscPress + 2e3) || ((27 != e.keyCode && 0 > ea.indexOf(e.keyCode) && (t.inputState.lastEscPress = 0),
                K.android && K.chrome && !e.synthetic && (13 == e.keyCode || 8 == e.keyCode)) ? (t.observer.delayAndroidKey(e.key, e.keyCode),
                !0) : !!(K.ios && !e.synthetic && !e.altKey && !e.metaKey && ((i = el.find(t=>t.keyCode == e.keyCode)) && !e.ctrlKey || eh.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey)) && (this.pendingIOSKey = i || e,
                setTimeout(()=>this.flushIOSKey(t), 250),
                !0))
            }
            flushIOSKey(t) {
                let e = this.pendingIOSKey;
                return !!e && (this.pendingIOSKey = void 0,
                M(t.contentDOM, e.key, e.keyCode))
            }
            ignoreDuringComposition(t) {
                return !!/^key/.test(t.type) && (this.composing > 0 || !!(K.safari && !K.ios && this.compositionPendingKey && Date.now() - this.compositionEndedAt < 100) && (this.compositionPendingKey = !1,
                !0))
            }
            mustFlushObserver(t) {
        ...
        class ed {
            constructor(t, e, i, s) {
                ...
                this.multiple = t.state.facet(l.yy.allowMultipleSelections) && ((o = t.state.facet(tg)).length ? o[0](e) : K.mac ? e.metaKey : e.ctrlKey),
                this.dragMove = (n = t.state.facet(tm)).length ? n[0](e) : K.mac ? !e.altKey : !e.ctrlKey,
            ...
            start(t) {
                !1 === this.dragging && (t.preventDefault(),
                this.select(t))
            }
            move(t) {
                var e;
                ...
                let i = 0
                  , s = 0
                  , o = (null === (e = this.scrollParent) || void 0 === e ? void 0 : e.getBoundingClientRect()) || {
                    left: 0,
                    top: 0,
                    right: this.view.win.innerWidth,
                    bottom: this.view.win.innerHeight
                };
                t.clientX <= o.left + 6 ? i = -ec(o.left - t.clientX) : t.clientX >= o.right - 6 && (i = ec(t.clientX - o.right)),
                t.clientY <= o.top + 6 ? s = -ec(o.top - t.clientY) : t.clientY >= o.bottom - 6 && (s = ec(t.clientY - o.bottom)),
        ...
        function eu(t, e) {
            ...
            for (let i = e.target, s; i != t.contentDOM; i = i.parentNode)
                if (!i || 11 == i.nodeType || (s = A.get(i)) && s.ignoreEvent(e))
                    return !1;
            return !0
        }
        let ef = Object.create(null)
          , ep = Object.create(null)
          , eg = K.ie && K.ie_version < 15 || K.ios && K.webkit_version < 604;
        function em(t, e) {
            let {state: i} = t, s, o = 1, n = i.toText(e), r = n.lines == i.selection.ranges.length;
            if (null != eA && i.selection.ranges.every(t=>t.empty) && eA == n.toString()) {
                let t = -1;
                s = i.changeByRange(s=>{
        ...
        function ev(t, e, i, s) {
            ...
            {
                let i = tc.find(t.docView, e)
                  , s = t.state.doc.lineAt(i ? i.posAtEnd : e)
                  , o = i ? i.posAtStart : s.from
                  , n = i ? i.posAtEnd : s.to;
                return n < t.state.doc.length && n == s.to && n++,
                l.jT.range(o, n)
            }
        }
        ef.keydown = (t,e)=>{
        ...
        ef.mousedown = (t,e)=>{
            ...
            t.inputState.lastTouchTime > Date.now() - 2e3)
                return;
            let n = null;
            for (let i of t.state.facet(tv))
                if (n = i(t, e))
                    break;
            if (n || 0 != e.button || (i = ey(t, e),
            s = eC(e),
            o = t.state.selection,
            n = {
                update(t) {
                    t.docChanged && (i.pos = t.changes.mapPos(i.pos),
                    o = o.map(t.changes))
                },
                get(e, n, r) {
                    let h = ey(t, e), a, c = ev(t, h.pos, h.bias, s);
                    if (i.pos != h.pos && !n) {
                        let e = ev(t, i.pos, i.bias, s)
                    ...
                    return n ? o.replaceRange(o.main.extend(c.from, c.to)) : r && 1 == s && o.ranges.length > 1 && (a = function(t, e) {
                        for (let i = 0; i < t.ranges.length; i++) {
                            ...
                            if (s <= e && o >= e)
                                return l.jT.create(t.ranges.slice(0, i).concat(t.ranges.slice(i + 1)), t.mainIndex == i ? 0 : t.mainIndex - (t.mainIndex > i ? 1 : 0))
                        }
                        return null
            ...
            n) {
                ...
                t.inputState.startMouseSelection(new ed(t,e,n,i)),
                i && t.observer.ignore(()=>x(t.contentDOM)),
                t.inputState.mouseSelection && t.inputState.mouseSelection.start(e)
            }
        }
        ;
        let ew = (t,e)=>t >= e.top && t <= e.bottom
          , eb = (t,e,i)=>ew(e, i) && t >= i.left && t <= i.right;
        function ey(t, e) {
            let i = t.posAtCoords({
                x: e.clientX,
                y: e.clientY
            ...
            return {
                ...
                bias: function(t, e, i, s) {
                    ...
                    return l && eb(i, s, l) ? 1 : r && ew(s, r) ? -1 : 1
                }(t, i, e.clientX, e.clientY)
            }
        }
        let ex = K.ie && K.ie_version <= 11
          , eS = null
          , eM = 0
          , ek = 0;
        function eC(t) {
            ...
            return eS = t,
            ek = Date.now(),
            eM = !e || i > Date.now() - 400 && 2 > Math.abs(e.clientX - t.clientX) && 2 > Math.abs(e.clientY - t.clientY) ? (eM + 1) % 3 : 1
        }
        function eD(t, e, i, s) {
            if (!i)
                return;
            ...
            let {mouseSelection: n} = t.inputState
              , r = s && n && n.dragging && n.dragMove ? {
                from: n.dragging.from,
                to: n.dragging.to
            } : null
              , l = {
                from: o,
        ...
        ef.dragstart = (t,e)=>{
            let {selection: {main: i}} = t.state
              , {mouseSelection: s} = t.inputState;
            s && (s.dragging = i),
            e.dataTransfer && (e.dataTransfer.setData("Text", t.state.sliceDoc(i.from, i.to)),
        ...
        ef.drop = (t,e)=>{
            ...
            if (i && i.length) {
                ...
                eD(t, e, e.dataTransfer.getData("Text"), !0)
        }
        ,
        ef.paste = (t,e)=>{
            if (t.state.readOnly)
                return e.preventDefault();
            t.observer.flush();
            let i = eg ? null : e.clipboardData;
            i ? (em(t, i.getData("text/plain") || i.getData("text/uri-text")),
        ...
        let eA = null;
        ef.copy = ef.cut = (t,e)=>{
            let {text: i, ranges: s, linewise: o} = function(t) {
                let e = []
                  , i = []
                  , s = !1;
                for (let s of t.selection.ranges)
                    s.empty || (e.push(t.sliceDoc(s.from, s.to)),
                    i.push(s));
                if (!e.length) {
                    let o = -1;
                    for (let {from: s} of t.selection.ranges) {
                        let n = t.doc.lineAt(s);
                        n.number > o && (e.push(n.text),
                        i.push({
                            from: n.from,
            ...
            if (!i && !o)
                return;
            eA = o ? i : null;
            let n = eg ? null : e.clipboardData;
            n ? (e.preventDefault(),
            n.clearData(),
            n.setData("text/plain", i)) : function(t, e) {
            ...
            "cut" != e.type || t.state.readOnly || t.dispatch({
                changes: s,
                scrollIntoView: !0,
        ...
        ,
        ef.compositionstart = ef.compositionupdate = t=>{
        ...
        ef.compositionend = t=>{
            ...
            K.chrome && K.android ? t.observer.flushSoon() : t.inputState.compositionPendingChange ? Promise.resolve().then(()=>t.observer.flush()) : setTimeout(()=>{
        ...
        ef.beforeinput = (t,e)=>{
            var i;
            let s;
            if (K.chrome && K.android && (s = el.find(t=>t.inputType == e.inputType)) && (t.observer.delayAndroidKey(s.key, s.keyCode),
            "Backspace" == s.key || "Delete" == s.key)) {
                let e = (null === (i = window.visualViewport) || void 0 === i ? void 0 : i.height) || 0;
                setTimeout(()=>{
                    var i;
                    ((null === (i = window.visualViewport) || void 0 === i ? void 0 : i.height) || 0) > e + 10 && t.hasFocus && (t.contentDOM.blur(),
                    t.focus())
                }
                , 100)
            }
        ...
        ;
        let eE = ["pre-wrap", "normal", "pre-line", "break-spaces"];
        class eB {
            constructor(t) {
                this.lineWrapping = t,
                this.doc = l.xv.empty,
            ...
            mustRefreshForWrapping(t) {
                return eE.indexOf(t) > -1 != this.lineWrapping
            }
            mustRefreshForHeights(t) {
                let e = !1;
                for (let i = 0; i < t.length; i++) {
                    let s = t[i];
                    s < 0 ? i++ : this.heightSamples[Math.floor(10 * s)] || (e = !0,
                    this.heightSamples[Math.floor(10 * s)] = !0)
                }
                return e
            }
            refresh(t, e, i, s, o, n) {
                let r = eE.indexOf(t) > -1
        ...
        class eH {
            ...
            join(t) {
                ...
                return new eH(this.from,this.length + t.length,this.top,this.height + t.height,e)
            }
        }
        var eV = ((r = eV || (eV = {}))[r.ByPos = 0] = "ByPos",
        ...
        class eP {
            ...
            setHeight(t, e) {
                this.height != e && (Math.abs(this.height - e) > .001 && (t.heightChanged = !0),
                this.height = e)
            }
            replace(t, e, i) {
                return eP.of(i)
            ...
            applyChanges(t, e, i, s) {
                ...
                for (let r = s.length - 1; r >= 0; r--) {
                    let {fromA: l, toA: h, fromB: a, toB: c} = s[r]
                      ...
                      , u = d.to >= h ? d : o.lineAt(h, eV.ByPosNoHeight, i, 0, 0);
                    for (c += u.to - h,
                    h = u.to; r > 0 && d.from <= s[r - 1].toA; )
                        l = s[r - 1].fromA,
                        a = s[r - 1].fromB,
                        r--,
            ...
            static of(t) {
                ...
                for (; ; )
                    if (e == i) {
                        if (s > 2 * o) {
                            let o = t[e - 1];
                            o.break ? t.splice(--e, 1, o.left, null, o.right) : t.splice(--e, 1, o.left, o.right),
                            i += 1 + o.break,
                            s -= o.size
                        } else if (o > 2 * s) {
                            let e = t[i];
                ...
                let n = 0;
                return null == t[e - 1] ? (n = 1,
                e--) : null == t[e] && (n = 1,
                i++),
                new eF(eP.of(t.slice(0, e)),n,eP.of(t.slice(i)))
            }
        }
        eP.prototype.size = 1;
        class eN extends eP {
            ...
            blockAt(t, e, i, s) {
                return new eH(s,this.length,i,this.height,this.type)
            }
            lineAt(t, e, i, s, o) {
        ...
        class eW extends eN {
            ...
            replace(t, e, i) {
                let s = i[0];
                return 1 == i.length && (s instanceof eW || s instanceof ez && 4 & s.flags) && 10 > Math.abs(this.length - s.length) ? (s instanceof ez ? s = new eW(s.length,this.height) : s.height = this.height,
                this.outdated || (s.outdated = !1),
                s) : eP.of(i)
            }
            updateHeight(t, e=0, i=!1, s) {
                return s && s.from <= e && s.more ? this.setHeight(t, s.heights[s.index++]) : (i || this.outdated) && this.setHeight(t, Math.max(this.widgetHeight, t.heightForLine(this.length - this.collapsed))),
                this.outdated = !1,
                this
            }
            toString() {
        ...
        class ez extends eP {
            ...
            heightMetrics(t, e) {
                let i = t.doc.lineAt(e).number, s = t.doc.lineAt(e + this.length).number, o = s - i + 1, n, r = 0;
                if (t.lineWrapping) {
                    let e = Math.min(this.height, t.lineHeight * o);
                    n = e / o,
                    this.length > o + 1 && (r = (this.height - e) / (this.length - o - 1))
                } else
                    n = this.height / o;
                return {
                    firstLine: i,
            ...
            lineAt(t, e, i, s, o) {
                ...
                if (e == eV.ByPosNoHeight) {
                    ...
                    return new eH(e,s - e,0,0,ts.Text)
                }
                ...
                return new eH(h.from,h.length,Math.max(s, Math.min(d, s + this.height - a)),a,ts.Text)
            }
            forEachLine(t, e, i, s, o, n) {
                t = Math.max(t, o),
                ...
                for (let a = t, c = s; a <= e; ) {
                    ...
                    let s = l + h * e.length;
                    n(new eH(e.from,e.length,c,s,ts.Text)),
                    c += s,
                    a = e.to + 1
                }
            }
            replace(t, e, i) {
                ...
                if (s > 0) {
                    let t = i[i.length - 1];
                    t instanceof ez ? i[i.length - 1] = new ez(t.length + s) : i.push(null, new ez(s - 1))
                }
                if (t > 0) {
                    let e = i[0];
                    e instanceof ez ? i[0] = new ez(t + e.length) : i.unshift(new ez(t - 1), null)
                }
                return eP.of(i)
            }
            decomposeLeft(t, e) {
                e.push(new ez(t - 1), null)
            }
            decomposeRight(t, e) {
                e.push(null, new ez(this.length - t - 1))
            }
            updateHeight(t, e=0, i=!1, s) {
                let o = e + this.length;
                if (s && s.from <= e + this.length && s.more) {
                    let i = []
                      , n = Math.max(e, s.from)
                      , r = -1;
                    for (s.from > e && i.push(new ez(s.from - e - 1).updateHeight(t, e)); n <= o && s.more; ) {
                        let e = t.doc.lineAt(n).length;
                        i.length && i.push(null);
                        let o = s.heights[s.index++];
                        -1 == r ? r = o : Math.abs(o - r) >= .001 && (r = -2);
                        let l = new eW(e,o);
                        l.outdated = !1,
                        i.push(l),
                        n += e + 1
                    }
                    n <= o && i.push(null, new ez(o - n).updateHeight(t, n));
                    let l = eP.of(i);
                    return (r < 0 || Math.abs(l.height - this.height) >= .001 || Math.abs(r - this.heightMetrics(t, e).perLine) >= .001) && (t.heightChanged = !0),
                    l
                }
        ...
        class eF extends eP {
            ...
            lineAt(t, e, i, s, o) {
                ...
                if (this.break || (l ? h.to < r : h.from > r))
                    return h;
                let a = e == eV.ByPosNoHeight ? eV.ByPosNoHeight : eV.ByPos;
            ...
            forEachLine(t, e, i, s, o, n) {
                ...
                if (this.break)
                    ...
                    let h = this.lineAt(l, eV.ByPos, i, s, o);
            ...
            balanced(t, e) {
                return t.size > 2 * e.size || e.size > 2 * t.size ? eP.of(this.break ? [t, null, e] : [t, e]) : (this.left = t,
                this.right = e,
            ...
            updateHeight(t, e=0, i=!1, s) {
                let {left: o, right: n} = this
                  ...
                  , l = null;
                return (s && s.from <= e + o.length && s.more ? l = o = o.updateHeight(t, e, i, s) : o.updateHeight(t, e, i),
                s && s.from <= r + n.length && s.more ? l = n = n.updateHeight(t, r, i, s) : n.updateHeight(t, r, i),
                l) ? this.balanced(o, n) : (this.height = this.left.height + this.right.height,
                this.outdated = !1,
                this)
            }
            toString() {
        ...
        function eI(t, e) {
            let i, s;
            null == t[e] && (i = t[e - 1])instanceof ez && (s = t[e + 1])instanceof ez && t.splice(e - 1, 3, new ez(i.length + 1 + s.length))
        }
        class eq {
            constructor(t, e) {
                this.pos = t,
            ...
            span(t, e) {
                if (this.lineStart > -1) {
                    ...
                    i instanceof eW ? i.length += t - this.pos : (t > this.pos || !this.isCovered) && this.nodes.push(new eW(t - this.pos,-1)),
                    this.writtenTo = t,
                    e > t && (this.nodes.push(null),
                    this.writtenTo++,
                    this.lineStart = -1)
                }
                this.pos = e
            ...
            point(t, e, i) {
                if (t < e || i.heightRelevant) {
                    ...
                    let o = e - t;
                    i.block ? this.addBlock(new eN(o,s,i.type)) : (o || s >= 5) && this.addLineDeco(s, o)
                } else
                    e > t && this.span(t, e);
            ...
            enterLine() {
                ...
                this.pos > t && this.nodes.push(new eW(this.pos - t,-1)),
            ...
            addBlock(t) {
                this.enterLine(),
                t.type != ts.WidgetAfter || this.isCovered || this.ensureLine(),
                this.nodes.push(t),
                this.writtenTo = this.pos = this.pos + t.length,
                t.type != ts.WidgetBefore && (this.covering = t)
            }
            addLineDeco(t, e) {
            ...
            finish(t) {
                ...
                !(this.lineStart > -1) || e instanceof eW || this.isCovered ? (this.writtenTo < this.pos || null == e) && this.nodes.push(this.blankContent(this.writtenTo, this.pos)) : this.nodes.push(new eW(0,-1));
                let i = t;
                for (let t of this.nodes)
                    t instanceof eW && t.updateHeight(this.oracle, i),
                    i += t ? t.length : 1;
                return this.nodes
            }
            static build(t, e, i, s) {
                let o = new eq(i,t);
                return l.Xs.spans(e, i, s, o, 0),
                o.finish(i)
            }
        }
        class eK {
            ...
            comparePoint(t, e, i, s) {
                (t < e || i && i.heightRelevant || s && s.heightRelevant) && ta(t, e, this.changes, 5)
            }
        }
        function ej(t, e) {
        ...
        class e_ {
            constructor(t) {
                ...
                this.defaultTextDirection = tF.LTR,
                this.visibleRanges = [],
                this.mustEnforceCursorAssoc = !1;
                let e = t.facet(tL).some(t=>"function" != typeof t && "cm-lineWrapping" == t.class);
                this.heightOracle = new eB(e),
                this.stateDeco = t.facet(tH).filter(t=>"function" != typeof t),
                this.heightMap = eP.empty().applyChanges(this.stateDeco, l.xv.empty, this.heightOracle.setDoc(t.doc), [new tW(0,0,0,t.doc.length)]),
                this.viewport = this.getViewport(0, null),
                this.updateViewportLines(),
                this.updateForViewport(),
                this.lineGaps = this.ensureLineGaps([]),
                this.lineGapDeco = to.set(this.lineGaps.map(t=>t.draw(!1))),
            ...
            updateForViewport() {
                ...
                this.scaler = this.heightMap.height <= 7e6 ? eZ : new eJ(this.heightOracle,this.heightMap,this.viewports)
            }
            updateViewportLines() {
                this.viewportLines = [],
                this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, t=>{
                    this.viewportLines.push(1 == this.scaler.scale ? t : e0(t, this.scaler))
                }
                )
            }
            update(t, e=null) {
                ...
                this.stateDeco = this.state.facet(tH).filter(t=>"function" != typeof t);
                let r = t.changedRanges
                  , h = tW.extendWithRanges(r, (i = this.stateDeco,
                s = t ? t.changes : l.as.empty(this.state.doc.length),
                o = new eK,
                l.Xs.compare(n, i, s, o, 0),
                o.changes))
                  , a = this.heightMap.height;
                this.heightMap = this.heightMap.applyChanges(this.stateDeco, t.startState.doc, this.heightOracle.setDoc(this.state.doc), h),
                this.heightMap.height != a && (t.flags |= 2);
                let c = h.length ? this.mapViewport(this.viewport, t.changes) : this.viewport;
                (e && (e.range.head < c.from || e.range.head > c.to) || !this.viewportIsAppropriate(c)) && (c = this.getViewport(0, e));
                let d = !t.changes.empty || 2 & t.flags || c.from != this.viewport.from || c.to != this.viewport.to;
                this.viewport = c,
                this.updateForViewport(),
                ...
                !this.mustEnforceCursorAssoc && t.selectionSet && t.view.lineWrapping && t.state.selection.main.empty && t.state.selection.main.assoc && !t.state.facet(tM) && (this.mustEnforceCursorAssoc = !0)
            }
            measure(t) {
                let e = t.contentDOM
                ...
                if (m != this.inView && (this.inView = m,
                m && (h = !0)),
                !this.inView && !this.scrollTarget)
                    return 0;
                let v = r.width;
                if ((this.contentDOMWidth != v || this.editorHeight != t.scrollDOM.clientHeight) && (this.contentDOMWidth = r.width,
                this.editorHeight = t.scrollDOM.clientHeight,
                a |= 8),
                h) {
                    let e = t.docView.measureVisibleLineHeights(this.viewport);
                    if (s.mustRefreshForHeights(e) && (n = !0),
                    n || s.lineWrapping && Math.abs(v - this.contentDOMWidth) > s.charWidth) {
                        let {lineHeight: i, charWidth: r, textHeight: l} = t.docView.measureTextSize();
                        (n = i > 0 && s.refresh(o, i, r, l, v / r, e)) && (t.docView.minWidth = 0,
                        a |= 8)
                    }
                    for (let i of (p > 0 && g > 0 ? c = Math.max(p, g) : p < 0 && g < 0 && (c = Math.min(p, g)),
                    s.heightChanged = !1,
                    this.viewports)) {
                        let o = i.from == this.viewport.from ? e : t.docView.measureVisibleLineHeights(i);
                        this.heightMap = (n ? eP.empty().applyChanges(this.stateDeco, l.xv.empty, this.heightOracle, [new tW(0,0,0,t.state.doc.length)]) : this.heightMap).updateHeight(s, 0, n, new eL(i.from,o))
                    }
                    s.heightChanged && (a |= 2)
                }
                ...
                return w && (this.viewport = this.getViewport(c, this.scrollTarget)),
                this.updateForViewport(),
                (2 & a || w) && this.updateViewportLines(),
                (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(n ? [] : this.lineGaps, t)),
            ...
            getViewport(t, e) {
                let i = .5 - Math.max(-.5, Math.min(.5, t / 1e3 / 2))
                  ...
                  , l = new eY(s.lineAt(n - 1e3 * i, eV.ByHeight, o, 0, 0).from,s.lineAt(r + (1 - i) * 1e3, eV.ByHeight, o, 0, 0).to);
                if (e) {
                    let {head: t} = e.range;
                    if (t < l.from || t > l.to) {
                        let i = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), n = s.lineAt(t, eV.ByPos, o, 0, 0), r;
                        r = "center" == e.y ? (n.top + n.bottom) / 2 - i / 2 : "start" == e.y || "nearest" == e.y && t < l.from ? n.top : n.bottom - i,
                        l = new eY(s.lineAt(r - 500, eV.ByHeight, o, 0, 0).from,s.lineAt(r + i + 500, eV.ByHeight, o, 0, 0).to)
                    }
                }
                return l
            }
            mapViewport(t, e) {
                let i = e.mapPos(t.from, -1)
                  , s = e.mapPos(t.to, 1);
                return new eY(this.heightMap.lineAt(i, eV.ByPos, this.heightOracle, 0, 0).from,this.heightMap.lineAt(s, eV.ByPos, this.heightOracle, 0, 0).to)
            }
            viewportIsAppropriate({from: t, to: e}, i=0) {
                if (!this.inView)
                    return !0;
                let {top: s} = this.heightMap.lineAt(t, eV.ByPos, this.heightOracle, 0, 0)
                  , {bottom: o} = this.heightMap.lineAt(e, eV.ByPos, this.heightOracle, 0, 0)
                  , {visibleTop: n, visibleBottom: r} = this;
            ...
            mapLineGaps(t, e) {
                ...
                let i = [];
                for (let s of t)
                    e.touchesRange(s.from, s.to) || i.push(new eG(e.mapPos(s.from),e.mapPos(s.to),s.size));
                return i
            }
            ensureLineGaps(t, e) {
                let i = this.heightOracle.lineWrapping
                  ...
                  , o = s >> 1
                  , n = s << 1;
                if (this.defaultTextDirection != tF.LTR && !i)
                    return [];
                let r = []
                  , h = (s,n,a,c)=>{
                    if (n - s < o)
                    ...
                    let d = this.state.selection.main
                      , u = [d.from];
                    for (let t of (d.empty || u.push(d.to),
                    u))
                        if (t > s && t < n) {
                            h(s, t - 10, a, c),
                            h(t + 10, n, a, c);
                    ...
                    if (!f) {
                        ...
                        f = new eG(s,n,this.gapSize(a, s, n, c))
                    }
                    r.push(f)
                }
                ;
                for (let t of this.viewportLines) {
                    ...
                    if (i) {
                        ...
                        let t, i, n = r.total * this.heightOracle.charWidth, l = s * this.heightOracle.charWidth;
                        if (null != a) {
                            let e = eQ(r, a)
            ...
            updateLineGaps(t) {
                eG.same(t, this.lineGaps) || (this.lineGaps = t,
                this.lineGapDeco = to.set(t.map(t=>t.draw(this.heightOracle.lineWrapping))))
            }
            ...
            lineBlockAt(t) {
                return t >= this.viewport.from && t <= this.viewport.to && this.viewportLines.find(e=>e.from <= t && e.to >= t) || e0(this.heightMap.lineAt(t, eV.ByPos, this.heightOracle, 0, 0), this.scaler)
            }
            lineBlockAtHeight(t) {
                return e0(this.heightMap.lineAt(this.scaler.fromDOM(t), eV.ByHeight, this.heightOracle, 0, 0), this.scaler)
            }
            elementAtHeight(t) {
                return e0(this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0), this.scaler)
            }
            get docHeight() {
        ...
        function eU({total: t, ranges: e}, i) {
            if (i <= 0)
                return e[0].from;
            if (i >= 1)
        ...
        function e0(t, e) {
            ...
            let i = e.toDOM(t.top)
              , s = e.toDOM(t.bottom);
            return new eH(t.from,t.length,i,s - i,Array.isArray(t.type) ? t.type.map(t=>e0(t, e)) : t.type)
        }
        let e1 = l.r$.define({
            combine: t=>t.join(" ")
        })
            ...
            constructor(t, e, i, s) {
                ...
                if (t.state.readOnly && e > -1)
                    ...
                    let e = o || n ? [] : function(t) {
                        ...
                        return i && (e.push(new t1(i,s)),
                        (o != i || n != s) && e.push(new t1(o,n))),
                        e
                    }(t)
                      , i = new tJ(e,t.state);
        ...
        function it(t, e) {
            ...
            if (e.bounds) {
                let {from: s, to: n} = e.bounds
                  , r = o.from
                  , h = null;
                (8 === t.inputState.lastKeyCode && t.inputState.lastKeyTime > Date.now() - 100 || K.android && e.text.length < n - s) && (r = o.to,
                h = "end");
                let a = function(t, e, i, s) {
                    let o = Math.min(t.length, e.length)
                      , n = 0;
                    for (; n < o && t.charCodeAt(n) == e.charCodeAt(n); )
                        n++;
                    if (n == o && t.length == e.length)
                        return null;
                    let r = t.length
                      , l = e.length;
                ...
                a && (K.chrome && 13 == t.inputState.lastKeyCode && a.toB == a.from + 2 && "￿￿" == e.text.slice(a.from, a.toB) && a.toB--,
                i = {
                    from: s + a.from,
                    to: s + a.toA,
                ...
                s && (!t.hasFocus && t.state.facet(tA) || s.main.eq(o)) && (s = null);
            if (!i && !s)
                return !1;
            ...
            } : (K.mac || K.android) && i && i.from == i.to && i.from == o.head - 1 && /^\. ?$/.test(i.insert.toString()) && "off" == t.contentDOM.getAttribute("autocorrect") ? (s && 2 == i.insert.length && (s = l.jT.single(s.main.anchor - 1, s.main.head - 1)),
            i = {
                from: o.from,
                to: o.to,
                insert: l.xv.of([" "])
            }) : K.chrome && i && i.from == i.to && i.from == o.head && "\n " == i.insert.toString() && t.lineWrapping && (s && (s = l.jT.single(s.main.anchor - 1, s.main.head - 1)),
            i = {
                from: o.from,
                to: o.to,
                insert: l.xv.of([" "])
            ...
            i) {
                let e, n = t.state;
                if (K.ios && t.inputState.flushIOSKey(t) || K.android && (i.from == o.from && i.to == o.to && 1 == i.insert.length && 2 == i.insert.lines && M(t.contentDOM, "Enter", 13) || i.from == o.from - 1 && i.to == o.to && 0 == i.insert.length && M(t.contentDOM, "Backspace", 8) || i.from == o.from && i.to == o.to + 1 && 0 == i.insert.length && M(t.contentDOM, "Delete", 46)))
                    return !0;
                let r = i.insert.toString();
                if (t.state.facet(ty).some(e=>e(t, i.from, i.to, r)))
                    return !0;
                if (t.inputState.composing >= 0 && t.inputState.composing++,
                i.from >= o.from && i.to <= o.to && i.to - i.from >= (o.to - o.from) / 3 && (!s || s.main.empty && s.main.from == i.from + i.insert.length) && t.inputState.composing < 0) {
                    let s = o.from < i.from ? n.sliceDoc(o.from, i.from) : ""
                      , r = o.to > i.to ? n.sliceDoc(i.to, o.to) : "";
                    e = n.replaceSelection(t.state.toText(s + i.insert.sliceString(0, void 0, t.state.lineBreak) + r))
                } else {
                    let r = n.changes(i)
                      , h = s && s.main.to <= r.newLength ? s.main : void 0;
                    if (n.selection.ranges.length > 1 && t.inputState.composing >= 0 && i.to <= o.to && i.to >= o.to - 10) {
                        ...
                        e = n.changeByRange(e=>{
                            ...
                            let u = e.to - c
                              , f = u - s.length;
                            if (e.to - e.from != d || t.state.sliceDoc(f, u) != s || a && e.to >= a.from && e.from <= a.to)
                                return {
                                    range: e
                                };
                            let p = n.changes({
                ...
                h += ".compose",
                t.inputState.compositionFirstChange && (h += ".start",
                ...
                return !1;
            {
                let e = !1
                  , i = "select";
                return t.inputState.lastSelectionTime > Date.now() - 50 && ("select" == t.inputState.lastSelectionOrigin && (e = !0),
        ...
        let ie = {
          ...
          , ii = K.ie && K.ie_version <= 11;
        class is {
            constructor(t) {
                this.view = t,
                this.active = !1,
                this.selectionRange = new b,
                ...
                this.start(),
                "function" == typeof IntersectionObserver && (this.intersection = new IntersectionObserver(t=>{
                    this.parentCheck < 0 && (this.parentCheck = setTimeout(this.listenForScroll.bind(this), 1e3)),
                    t.length > 0 && t[t.length - 1].intersectionRatio > 0 != this.intersecting && (this.intersecting = !this.intersecting,
            ...
            updateGaps(t) {
                if (this.gapIntersection && (t.length != this.gaps.length || this.gaps.some((e,i)=>e != t[i]))) {
                    for (let e of (this.gapIntersection.disconnect(),
                    t))
            ...
            onSelectionChange(t) {
                ...
                if (i.state.facet(tA) ? i.root.activeElement != this.dom : !u(i.dom, s))
                    return;
                ...
                (K.ie && K.ie_version <= 11 || K.android && K.chrome) && !i.state.selection.main.empty && s.focusNode && p(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset) ? this.flushSoon() : this.flush(!1)
            }
            readSelectionRange() {
                let {view: t} = this
                  , e = K.safari && 11 == t.root.nodeType && function(t) {
                    ...
                    if (t.contentDOM.addEventListener("beforeinput", i, !0),
                ...
                return i && !this.selectionChanged && t.inputState.lastFocusTime > Date.now() - 200 && t.inputState.lastTouchTime < Date.now() - 300 && function(t, e) {
                    let i = e.focusNode
                      , s = e.focusOffset;
                    if (!i || e.anchorNode != i || e.anchorOffset != s)
                        return !1;
                    for (; ; )
                        if (s) {
                            if (1 != i.nodeType)
                ...
                }(this.dom, e) ? (this.view.inputState.lastFocusTime = 0,
                t.docView.updateSelection(),
                !1) : (this.selectionRange.setRange(e),
            ...
            start() {
                this.active || (this.observer.observe(this.dom, ie),
                ii && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData),
                this.active = !0)
            }
            stop() {
                this.active && (this.active = !1,
                this.observer.disconnect(),
                ii && this.dom.removeEventListener("DOMCharacterDataModified", this.onCharData))
            }
            clear() {
                this.processRecords(),
                this.queue.length = 0,
            ...
            delayAndroidKey(t, e) {
                ...
                if (!this.delayedAndroidKey) {
                    let t = ()=>{
                        ...
                        t && (this.clearDelayedAndroidKey(),
                        !this.flush() && t.force && M(this.dom, t.key, t.keyCode))
                    }
                    ;
            ...
            processRecords() {
                ...
                for (let o of t) {
                    ...
                    t && (t.typeOver && (s = !0),
                    -1 == e ? {from: e, to: i} = t : (e = Math.min(t.from, e),
                    i = Math.max(t.to, i)))
                }
                return {
                    from: e,
            ...
            readChange() {
                ...
                return t < 0 && !s ? null : (t > -1 && (this.lastChange = Date.now()),
                this.view.inputState.lastFocusTime = 0,
                this.selectionChanged = !1,
                new e7(this.view,t,e,i))
            }
            flush(t=!0) {
                ...
                let i = this.view.state
                  , s = it(this.view, e);
                return this.view.state == i && this.view.update([]),
                s
            }
            readMutation(t) {
                ...
                if (!e || e.ignoreMutation(t))
                    return null;
                if (e.markDirty("attributes" == t.type),
                "attributes" == t.type && (e.dirty |= 4),
                "childList" == t.type) {
                    let i = io(e, t.previousSibling || t.target.previousSibling, -1)
                      , s = io(e, t.nextSibling || t.target.nextSibling, 1);
                    return {
        ...
        class ir {
            constructor(t={}) {
                ...
                this.viewState = new e_(t.state || l.yy.create(t)),
                this.plugins = this.state.facet(tO).map(t=>new tE(t)),
                this.plugins))
                    e.update(this);
                this.observer = new is(this),
                this.inputState = new er(this),
                this.inputState.ensureHandlers(this, this.plugins),
                this.docView = new t2(this),
                this.mountStyles(),
                this.updateAttrs(),
                this.updateState = 0,
                this.requestMeasure(),
            ...
            update(t) {
                ...
                let n = this.hasFocus
                  , r = 0
                  , h = null;
                t.some(t=>t.annotation(eT)) ? (this.inputState.notifiedFocused = n,
                r = 1) : n == this.inputState.notifiedFocused || (this.inputState.notifiedFocused = n,
                (h = eO(o, n)) || (r = 1));
                let a = this.observer.delayedAndroidKey
                  , c = null;
                if (a ? (this.observer.clearDelayedAndroidKey(),
                ((c = this.observer.readChange()) && !this.state.doc.eq(o.doc) || !this.state.selection.eq(o.selection)) && (c = null)) : this.observer.clear(),
                o.facet(l.yy.phrases) != this.state.facet(l.yy.phrases))
                    return this.setState(o);
                s = tz.create(this, o, t),
                s.flags |= r;
                let d = this.viewState.scrollTarget;
                try {
                    for (let e of (this.updateState = 2,
                    t)) {
                        if (d && (d = d.map(e.changes)),
                        e.scrollIntoView) {
                            let {main: t} = e.state.selection;
                            d = new tk(t.empty ? t : l.jT.cursor(t.head, t.head > t.anchor ? -1 : 1))
                        }
                        for (let t of e.effects)
                            t.is(tC) && (d = t.value)
                    }
                    this.viewState.update(s, d),
                    this.bidiCache = ia.update(this.bidiCache, s.changes),
                    ...
                    this.docView.updateSelection(e, t.some(t=>t.isUserEvent("select.pointer")))
                } finally {
                    this.updateState = 0
                }
                if (s.startState.facet(e1) != s.state.facet(e1) && (this.viewState.mustMeasureContent = !0),
                (e || i || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(),
                !s.empty)
                    for (let t of this.state.facet(tb))
                        t(s);
                (h || c) && Promise.resolve().then(()=>{
                    h && this.state == h.startState && this.dispatch(h),
                    c && !it(this, c) && a.force && M(this.contentDOM, a.key, a.keyCode)
                }
                )
            }
            setState(t) {
                ...
                try {
                    for (let t of this.plugins)
                        t.destroy(this);
                    for (let e of (this.viewState = new e_(t),
                    this.plugins = t.facet(tO).map(t=>new tE(t)),
                    ...
                    for (let t = 0; ; t++) {
                        ...
                        let l = r.map(t=>{
                            try {
                                ...
                                return tD(this.state, t),
                                ih
                            }
                        }
                        )
                          , h = tz.create(this, this.state, [])
                          , a = !1
                          , c = !1;
                        h.flags |= o,
                        e ? e.flags |= o : e = h,
                        ...
                        if (this.viewState.editorHeight) {
                            if (this.viewState.scrollTarget)
                                ...
                                (t > 1 || t < -1) && (this.scrollDOM.scrollTop += t,
                                c = !0)
                            }
                        }
                        if (a && this.docView.updateSelection(!0),
            ...
            get themeClasses() {
                return e8 + " " + (this.state.facet(e2) ? e9 : e3) + " " + this.state.facet(e1)
            }
            updateAttrs() {
                let t = ic(this, tB, {
                  ...
                  , e = {
                    ...
                    autocapitalize: "off",
                    translate: "no",
                    contenteditable: this.state.facet(tA) ? "true" : "false",
                    class: "cm-content",
                ...
                let i = this.observer.ignore(()=>{
                    let i = te(this.contentDOM, this.contentAttrs, e)
                      , s = te(this.dom, this.editorAttrs, t);
                    return i || s
                }
                );
            ...
            plugin(t) {
                ...
                return (void 0 === e || e && e.spec != t) && this.pluginMap.set(t, e = this.plugins.find(e=>e.spec == t) || null),
            ...
            moveByChar(t, e, i) {
                return en(this, t, eo(this, t, e, i))
            }
            moveByGroup(t, e) {
                return en(this, t, eo(this, t, e, e=>{
                    var i;
                    let s, o;
                    return i = t.head,
            ...
            moveToLineBoundary(t, e, i=!0) {
                return function(t, e, i, s) {
                    let o = t.state.doc.lineAt(e.head)
                      , n = s && t.lineWrapping ? t.coordsAtPos(e.assoc < 0 && e.head > o.from ? e.head - 1 : e.head) : null;
                    if (n) {
                        let e = t.dom.getBoundingClientRect()
                          , s = t.textDirectionAt(o.from)
                          , r = t.posAtCoords({
                            x: i == (s == tF.LTR) ? e.right - 1 : e.left + 1,
                            y: (n.top + n.bottom) / 2
                        });
                        if (null != r)
                            return l.jT.cursor(r, i ? -1 : 1)
                    }
                    let r = tc.find(t.docView, e.head)
                      , h = r ? i ? r.posAtEnd : r.posAtStart : i ? o.to : o.from;
                    return l.jT.cursor(h, i ? -1 : 1)
                }(this, t, e, i)
            }
            moveVertically(t, e, i) {
                return en(this, t, function(t, e, i, s) {
                    let o = e.head
                      , n = i ? 1 : -1;
                    if (o == (i ? t.state.doc.length : 0))
                        return l.jT.cursor(o, e.assoc);
                    let r = e.goalColumn, h, a = t.contentDOM.getBoundingClientRect(), c = t.coordsAtPos(o), d = t.documentTop;
                    if (c)
                        null == r && (r = c.left - a.left),
                        h = n < 0 ? c.top : c.bottom;
                    else {
                        let e = t.viewState.lineBlockAt(o);
                        null == r && (r = Math.min(a.right - a.left, t.defaultCharacterWidth * (o - e.from))),
            ...
            coordsAtPos(t, e=1) {
                ...
                let s = this.state.doc.lineAt(t)
                  , o = this.bidiSpans(s);
                return w(i, o[tY.find(o, t - s.from, -1, e)].dir == tF.LTR == e > 0)
            }
            ...
            textDirectionAt(t) {
                return !this.state.facet(tS) || t < this.viewport.from || t > this.viewport.to ? this.textDirection : (this.readMeasured(),
            ...
            bidiSpans(t) {
                ...
                let i = function(t, e) {
                    ...
                    for (let e = 0, o = s, r = s; e < i; e++) {
                        var n;
                        let i = (n = t.charCodeAt(e)) <= 247 ? tj[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? t$[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8203 ? 256 : 64336 <= n && n <= 65023 ? 4 : 8204 == n ? 256 : 1;
                    ...
                    for (let t = 0, e = s, o = s; t < i; t++) {
                        let s = tU[t];
                        if (128 == s)
                            t < i - 1 && e == tU[t + 1] && 24 & e ? s = tU[t] = e : tU[t] = 256;
                        else if (64 == s) {
                            let s = t + 1;
                            for (; s < i && 64 == tU[s]; )
                                s++;
                            let n = t && 8 == e || s < i && 8 == tU[s] ? 1 == o ? 1 : 8 : 256;
                            for (let e = t; e < s; e++)
                                tU[e] = n;
                            t = s - 1
                        } else
                    ...
                    for (let e = 0, n = 0, r = 0, l, h, a; e < i; e++)
                        if (h = tG[l = t.charCodeAt(e)]) {
                            ...
                            } else if (189 == tX.length)
                                break;
                            else
                                tX[n++] = e,
                                tX[n++] = l,
                                tX[n++] = r
                        } else if (2 == (a = tU[e]) || 1 == a) {
                            let t = a == s;
                            r = t ? 0 : 1;
                ...
                return this.bidiCache.push(new ia(t.from,t.to,e,i)),
                i
            }
            get hasFocus() {
                var t;
            ...
            setRoot(t) {
                ...
                this.observer.setWindow((9 == t.nodeType ? t : t.ownerDocument).defaultView || window),
                this.mountStyles())
            }
            destroy() {
                for (let t of this.plugins)
            ...
            static scrollIntoView(t, e={}) {
                return tC.of(new tk("number" == typeof t ? l.jT.cursor(t) : t,e.y,e.x,e.yMargin,e.xMargin))
            }
            ...
            static theme(t, e) {
                let i = h.V.newName()
                  , s = [e1.of(i), tN.of(e4(`.${i}`, t))];
                return e && e.dark && s.push(e2.of(!0)),
                s
            }
            static baseTheme(t) {
                return l.Wl.lowest(tN.of(e4("." + e8, t, e5)))
            }
        ...
        ir.styleModule = tN,
        ir.inputHandler = ty,
        ir.focusChangeEffect = tx,
        ir.perLineTextDirection = tS,
        ir.exceptionSink = tw,
        ir.updateListener = tb,
        ir.editable = tA,
        ir.mouseSelectionStyle = tv,
        ir.dragMovesSelection = tm,
        ir.clickAddsSelectionRange = tg,
        ir.decorations = tH,
        ir.atomicRanges = tV,
        ir.scrollMargins = tP,
        ir.darkTheme = e2,
        ir.contentAttributes = tL,
        ir.editorAttributes = tB,
        ir.lineWrapping = ir.contentAttributes.of({
            class: "cm-lineWrapping"
        }),
        ir.announce = l.Py.define();
        let il = 4096
          , ih = {};
        class ia {
            constructor(t, e, i, s) {
            ...
            static update(t, e) {
                if (e.empty)
                    return t;
                let i = []
                  , s = t.length ? t[t.length - 1].dir : tF.LTR;
                for (let o = Math.max(0, t.length - 10); o < t.length; o++) {
                    let n = t[o];
                    n.dir != s || e.touchesRange(n.from, n.to) || i.push(new ia(e.mapPos(n.from, 1),e.mapPos(n.to, -1),n.dir,n.order))
                }
                return i
            }
        }
        ...
        let id = K.mac ? "mac" : K.windows ? "win" : K.linux ? "linux" : "key";
        function iu(t, e, i) {
        ...
        let ip = l.Wl.default(ir.domEventHandlers({
            keydown: (t,e)=>iy(iv(e.state), t, e, "editor")
        }))
          , ig = l.r$.define({
            enables: ip
        })
        ...
        function iv(t) {
            let e = t.facet(ig)
              , i = im.get(e);
            return i || im.set(e, i = function(t, e=id) {
                let i = Object.create(null)
                  ...
                  , o = (t,e)=>{
                    ...
                    if (null == i)
                        ...
                        throw Error("Key binding " + t + " is used both as a regular binding and as a multi-stroke prefix")
                }
                  , n = (t,s,n,r)=>{
                    var l, h;
                    let a = i[t] || (i[t] = Object.create(null))
                      , c = s.split(/ (?!$)/).map(t=>(function(t, e) {
                        let i, s, o, n;
                        let r = t.split(/-(?!$)/)
                          , l = r[r.length - 1];
                        "Space" == l && (l = " ");
                    ...
                    let u = a[d] || (a[d] = {
                        preventDefault: !1,
                        run: (null === (h = null === (l = a._any) || void 0 === l ? void 0 : l.run) || void 0 === h ? void 0 : h.slice()) || []
                    });
                    n && u.run.push(n),
                    r && (u.preventDefault = !0)
                }
                ;
                for (let s of t) {
                    ...
                    if (o)
                        for (let e of t)
                            ...
                            s.shift && n(e, "Shift-" + o, s.shift, s.preventDefault)
                }
                return i
        ...
        function iy(t, e, i, s) {
            ...
            l.nZ)(n) == o.length && " " != o
              , h = ""
              , c = !1;
            ib && ib.view == i && ib.scope == s && (h = ib.prefix + " ",
            (c = 0 > ea.indexOf(e.keyCode)) && (ib = null));
            let d = new Set, u = t=>{
                if (t) {
                    for (let s of t.run)
                        if (!d.has(s) && (d.add(s),
            ...
            if (f) {
                if (u(f[h + iu(o, e, !r)]))
                    return !0;
                if (r && (e.altKey || e.metaKey || e.ctrlKey) && !(K.windows && e.ctrlKey && e.altKey) && (p = a.ue[e.keyCode]) && p != o) {
                    if (u(f[h + iu(p, e, !0)]) || e.shiftKey && (g = a.uY[e.keyCode]) != o && g != p && u(f[h + iu(g, e, !1)]))
                        return !0
                } else if (r && e.shiftKey && u(f[h + iu(o, e, !0)]))
                    return !0;
                if (u(f._any))
                    return !0
            }
        ...
        class ix {
            ...
            update(t, e) {
                return e.className == this.className && (this.adjust(t),
                !0)
            }
            adjust(t) {
            ...
            static forRange(t, e, i) {
                if (!i.empty)
                    return function(t, e, i) {
                        ...
                        let s = Math.max(i.from, t.viewport.from)
                          ...
                          , f = ik(t, s)
                          , p = ik(t, o)
                          , g = f.type == ts.Text ? f : null
                          , m = p.type == ts.Text ? p : null;
                        if (t.lineWrapping && (g && (g = iM(t, s, g)),
                        m && (m = iM(t, o, m))),
                        g && m && g.from == m.from)
                            return w(b(i.from, i.to, g));
                        {
                            let e = g ? b(i.from, null, g) : y(f, !1)
                              ...
                              , o = [];
                            return (g || f).to < (m || p).from - 1 ? o.push(v(d, e.bottom, u, s.top)) : e.bottom < s.top && t.elementAtHeight((e.bottom + s.top) / 2).type == ts.Text && (e.bottom = s.top = (e.bottom + s.top) / 2),
                            w(e).concat(o).concat(w(s))
                        }
                        function v(t, i, s, o) {
                            return new ix(e,t - h.left,i - h.top - .01,s - t,o - i + .01)
                        }
                        ...
                        function b(e, i, s) {
                            ...
                            function h(e, i, h, a, c) {
                                ...
                                f && p && (o = Math.min(f.top, p.top, o),
                                r = Math.max(f.bottom, p.bottom, r),
                                c == tF.LTR ? l.push(n && i ? d : f.left, n && a ? u : p.right) : l.push(!n && a ? d : p.left, !n && i ? u : f.right))
                            }
                    ...
                    }(t, e, i);
                {
                    ...
                    if (!s)
                        return [];
                    let o = iS(t);
                    return [new ix(e,s.left - o.left,s.top - o.top,null,s.bottom - s.top)]
                }
            }
        }
        function iS(t) {
            ...
            return {
                left: (t.textDirection == tF.LTR ? e.left : e.right - t.scrollDOM.clientWidth) - t.scrollDOM.scrollLeft,
        ...
        function ik(t, e) {
            ...
            if (Array.isArray(i.type)) {
                for (let t of i.type)
                    if (t.to > e || t.to == e && (t.to == i.to || t.type == ts.Text))
                        return t
            }
            return i
        }
        class iC {
            ...
            update(t) {
                t.startState.facet(iD) != t.state.facet(iD) && this.setOrder(t.state),
                (this.layer.update(t, this.dom) || t.geometryChanged) && t.view.requestMeasure(this.measureReq)
            }
            setOrder(t) {
                let e = 0
                  , i = t.facet(iD);
        ...
        let iD = l.r$.define();
        function iA(t) {
            return [tR.define(e=>new iC(e,t)), iD.of(t)]
        }
        let iT = !K.ios
          , iO = l.r$.define({
            combine: t=>(0,
        ...
        function iR(t={}) {
            return [iO.of(t), iB, iH, iP, tM.of(!0)]
        }
        function iE(t) {
        ...
        let iB = iA({
            ...
            markers(t) {
                ...
                for (let o of e.selection.ranges) {
                    ...
                    if (o.empty ? !n || iT : i.drawRangeCursor) {
                        ...
                        for (let o of ix.forRange(t, e, i))
                            s.push(o)
                    }
                }
                return s
            ...
            update(t, e) {
                ...
                let i = iE(t);
                return i && iL(t.state, e),
                t.docChanged || t.selectionSet || i
            },
            mount(t, e) {
                iL(e.state, t)
            },
        ...
        let iH = iA({
            above: !1,
            markers: t=>t.state.selection.ranges.map(e=>e.empty ? [] : ix.forRange(t, "cm-selectionBackground", e)).reduce((t,e)=>t.concat(e)),
        ...
        iT && (iV[".cm-line"].caretColor = "transparent !important");
        let iP = l.Wl.highest(ir.theme(iV))
          , iN = l.Py.define({
            map: (t,e)=>null == t ? null : e.mapPos(t)
        })
          , iW = l.QQ.define({
            create: ()=>null,
            update: (t,e)=>(null != t && (t = e.changes.mapPos(t)),
            e.effects.reduce((t,e)=>e.is(iN) ? e.value : t, t))
        })
          , iz = tR.fromClass(class {
            constructor(t) {
                this.view = t,
                this.cursor = null,
                this.measureReq = {
            ...
            update(t) {
                ...
                null == i ? null != this.cursor && (null === (e = this.cursor) || void 0 === e || e.remove(),
                this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")),
                this.cursor.className = "cm-dropCursor"),
                (t.startState.field(iW) != i || t.docChanged || t.geometryChanged) && this.view.requestMeasure(this.measureReq))
            }
            readPos() {
            ...
            drawCursor(t) {
                this.cursor && (t ? (this.cursor.style.left = t.left + "px",
                this.cursor.style.top = t.top + "px",
                this.cursor.style.height = t.height + "px") : this.cursor.style.left = "-100000px")
            }
            destroy() {
        ...
        class iq {
            constructor(t) {
                let {regexp: e, decoration: i, decorate: s, boundary: o, maxLength: n=1e3} = t;
                if (!e.global)
            ...
            createDeco(t) {
                ...
                for (let {from: e, to: s} of function(t, e) {
                    ...
                    if (1 == i.length && i[0].from == t.viewport.from && i[0].to == t.viewport.to)
                        return i;
                    let s = [];
                    for (let {from: o, to: n} of i)
                        o = Math.max(t.state.doc.lineAt(o).from, o - e),
                        n = Math.min(t.state.doc.lineAt(n).to, n + e),
                        s.length && s[s.length - 1].to >= o ? s[s.length - 1].to = n : s.push({
                            from: o,
                            to: n
                        });
                    return s
                }(t, this.maxLength))
                    iI(t.state.doc, this.regexp, e, s, (e,s)=>this.addMatch(s, t, e, i));
                return e.finish()
            }
            updateDeco(t, e) {
                let i = 1e9
                ...
                return (t.docChanged && t.changes.iterChanges((e,o,n,r)=>{
                    r > t.view.viewport.from && n < t.view.viewport.to && (i = Math.min(n, i),
                    s = Math.max(r, s))
                }
                ),
            ...
            updateRange(t, e, i, s) {
                for (let o of t.visibleRanges) {
                    ...
                    if (r > n) {
                        ...
                        let a = [], c, d = (t,e,i)=>a.push(i.range(t, e));
                        if (i == s)
                            for (this.regexp.lastIndex = l - i.from; (c = this.regexp.exec(i.text)) && c.index < h - i.from; )
                                this.addMatch(c, t, c.index + i.from, d);
                        else
                            iI(t.state.doc, this.regexp, l, h, (e,i)=>this.addMatch(i, t, e, d));
                        e = e.update({
                            filterFrom: l,
                            filterTo: h,
                            filter: (t,e)=>t < l || e > h,
          ...
          , iX = l.r$.define({
            combine(t) {
                ...
                return (e.replaceTabs = !function() {
                    ...
                    return iG || !1
                }()) && (e.specialChars = RegExp("	|" + e.specialChars.source, iK)),
                e.addSpecialChars && (e.specialChars = RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, iK)),
                e
            }
        });
        function i_(t={}) {
            return [iX.of(t), iY || (iY = tR.fromClass(class {
                constructor(t) {
                    this.view = t,
                    this.decorations = to.none,
                    this.decorationCache = Object.create(null),
                    this.decorator = this.makeDecorator(t.state.facet(iX)),
                        ...
                        decoration: (e,i,s)=>{
                            ...
                            if (9 == n) {
                                let t = o.lineAt(s)
                                  , e = i.state.tabSize
                                  , n = (0,
                                l.IS)(t.text, e, s - t.from);
                                return to.replace({
                                    widget: new iQ((e - n % e) * this.view.defaultCharacterWidth)
                                })
                            }
                            return this.decorationCache[n] || (this.decorationCache[n] = to.replace({
                                widget: new iU(t,n)
                            }))
                        }
                        ,
                ...
                update(t) {
                    let e = t.state.facet(iX);
                    t.startState.facet(iX) != e ? (this.decorator = this.makeDecorator(e),
                    this.decorations = this.decorator.createDeco(t.view)) : this.decorations = this.decorator.updateDeco(t, this.decorations)
                }
            }
            , {
          ...
          , i0 = tR.fromClass(class {
            ...
            getDeco(t) {
                ...
                for (let s of t.state.selection.ranges) {
                    ...
                    o.from > e && (i.push(iJ.range(o.from)),
                    e = o.from)
                }
                return to.set(i)
            }
        ...
        class i1 extends ti {
            ...
            coordsAt(t) {
                ...
                return e.length ? w(e[0], "rtl" != window.getComputedStyle(t).direction) : null
            }
            ignoreEvent() {
                return !1
            }
        ...
        function i2(t) {
            return tR.fromClass(class {
                constructor(e) {
                    this.view = e,
                    this.placeholder = to.set([to.widget({
                        widget: new i1(t),
                        side: 1
                    }).range(0)])
                }
                get decorations() {
                    return this.view.state.doc.length ? to.none : this.placeholder
                }
            }
            , {
                decorations: t=>t.decorations
        ...
        function i8(t, e) {
            ...
            let s, o = t.posAtCoords({
                x: e.clientX,
                y: e.clientY
            }, !1), n = t.state.doc.lineAt(o), r = o - n.from, h = r > 2e3 ? -1 : r == n.length ? (i = e.clientX,
            (s = t.coordsAtPos(t.viewport.from)) ? Math.round(Math.abs((s.left - i) / t.defaultCharacterWidth)) : -1) : (0,
            l.IS)(n.text, t.state.tabSize, o - n.from);
            return {
                line: n.number,
                col: h,
                off: r
        ...
        function i3(t) {
            ...
            return ir.mouseSelectionStyle.of((t,i)=>{
                let s, o;
                return e(i) ? (s = i8(t, i),
                o = t.state.selection,
                s ? {
                        ...
                        let h = function(t, e, i) {
                            ...
                            if (e.off > 2e3 || i.off > 2e3 || e.col < 0 || i.col < 0) {
                                ...
                                for (let e = s; e <= o; e++) {
                                    let i = t.doc.line(e)
                                      , s = (0,
                                    l.Gz)(i.text, r, t.tabSize, !0);
                                    if (s < 0)
                                        n.push(l.jT.cursor(i.to));
                                    else {
                                        let e = (0,
                                        l.Gz)(i.text, h, t.tabSize);
        ...
        function i4(t={}) {
            let[e,i] = i9[t.key || "Alt"]
              , s = tR.fromClass(class {
                constructor(t) {
                    this.view = t,
                    this.isDown = !1
                }
                set(t) {
                    this.isDown != t && (this.isDown = t,
                    this.view.update([]))
                }
            }
            , {
            ...
            return [s, ir.contentAttributes.of(t=>{
                var e;
        ...
        let se = l.r$.define({
          ...
          , ss = tR.fromClass(class {
            constructor(t) {
                ...
                this.manager = new i7(t,sr,t=>this.createTooltip(t)),
                this.intersectionObserver = "function" == typeof IntersectionObserver ? new IntersectionObserver(t=>{
            ...
            destroy() {
                var t, e;
                for (let e of (this.view.win.removeEventListener("resize", this.measureSoon),
                this.manager.tooltipViews))
                    e.dom.remove(),
            ...
            writeMeasure(t) {
                ...
                for (let n = 0; n < this.manager.tooltips.length; n++) {
                    ...
                    let d = r.arrow ? l.dom.querySelector(".cm-tooltip-arrow") : null
                      ...
                      , g = l.offset || sn
                      , m = this.view.textDirection == tF.LTR
                    ...
                    if (!0 !== l.overlap)
                        for (let t of o)
                            t.left < x && t.right > v && t.top < y + p && t.bottom > y && (y = w ? t.top - p - 2 - u : t.bottom + u + 2);
                    "absolute" == this.position ? (h.style.top = y - t.parent.top + "px",
                    h.style.left = v - t.parent.left + "px") : (h.style.top = y + "px",
                    h.style.left = v + "px"),
                    d && (d.style.left = `${a.left + (m ? g.x : -g.x) - (v + 14 - 7)}px`),
                    !0 !== l.overlap && o.push({
                        left: v,
                        top: y,
                        right: x,
        ...
        class sh {
            constructor(t) {
                ...
                this.manager = new i7(t,sl,t=>this.createHostedView(t))
            }
            static create(t) {
                return new sh(t)
            }
            createHostedView(t) {
                let e = t.create(this.view);
                return e.dom.classList.add("cm-tooltip-section"),
        ...
        class sc {
            ...
            startHover() {
                clearTimeout(this.restartTimeout);
                let {lastMove: t} = this
                  , e = this.view.contentDOM.contains(t.target) ? this.view.posAtCoords(t) : null;
                if (null == e)
                    return;
                let i = this.view.coordsAtPos(e);
                if (null == i || t.y < i.top || t.y > i.bottom || t.x < i.left - this.view.defaultCharacterWidth || t.x > i.right + this.view.defaultCharacterWidth)
                    return;
                let s = this.view.bidiSpans(this.view.state.doc.lineAt(e)).find(t=>t.from <= e && t.to >= e)
                  , o = s && s.dir == tF.RTL ? -1 : 1
            ...
            mouseleave(t) {
                ...
                this.hoverTimeout = -1,
                this.active && !sd(t.relatedTarget) && this.view.dispatch({
                    effects: this.setHover.of(null)
                })
            }
            destroy() {
        ...
        function su(t, e={}) {
            let i = l.Py.define()
              , s = l.QQ.define({
                create: ()=>null,
                update(t, s) {
                    if (t && (e.hideOnChange && (s.docChanged || s.selection) || e.hideOn && e.hideOn(s, t)))
                        return null;
                    if (t && s.docChanged) {
            ...
            return [s, tR.define(o=>new sc(o,t,s,i,e.hoverTime || 300)), sa]
        }
        function sf(t, e) {
            let i = t.plugin(ss);
            if (!i)
        ...
        let sv = tR.fromClass(class {
            constructor(t) {
                this.input = t.state.facet(sy),
                this.specs = this.input.filter(t=>t),
                this.panels = this.specs.map(e=>e(t));
                let e = t.state.facet(sg);
                for (let i of (this.top = new sw(t,!0,e.topContainer),
            ...
            update(t) {
                ...
                this.bottom = new sw(t.view,!1,e.bottomContainer)),
                ...
                if (i != this.input) {
                    let e = i.filter(t=>t)
                      ...
                      , r = [];
                    for (let i of e) {
                        let e = this.specs.indexOf(i), l;
                        e < 0 ? (l = i(t.view),
                        r.push(l)) : (l = this.panels[e]).update && l.update(t),
                        s.push(l),
                        (l.top ? o : n).push(l)
                    }
        ...
        , {
            provide: t=>ir.scrollMargins.of(e=>{
                let i = e.plugin(t);
                return i && {
        ...
        sx.prototype.elementClass = "",
        sx.prototype.toDOM = void 0,
        sx.prototype.mapMode = l.gc.TrackBefore,
        sx.prototype.startSide = sx.prototype.endSide = -1,
        sx.prototype.point = !0;
        let sS = l.r$.define()
          , sM = {
            class: "",
          ...
          , sk = l.r$.define();
        function sC(t) {
            return [sA(), sk.of(Object.assign(Object.assign({}, sM), t))]
        }
        let sD = l.r$.define({
            combine: t=>t.some(t=>t)
        });
        function sA(t) {
            let e = [sT];
            return t && !1 === t.fixed && e.push(sD.of(!0)),
            e
        }
        let sT = tR.fromClass(class {
            constructor(t) {
                ...
                this.gutters = t.state.facet(sk).map(e=>new sB(t,e)),
                this.gutters))
                    this.dom.appendChild(e.dom);
                this.fixed = !t.state.facet(sD),
            ...
            update(t) {
                ...
                this.view.state.facet(sD) != !this.fixed && (this.fixed = !this.fixed,
            ...
            syncGutters(t) {
                ...
                for (let t of this.view.viewportLineBlocks) {
                    ...
                    if (Array.isArray(t.type)) {
                        ...
                        e = t.type == ts.Text ? t : void 0;
                    if (e)
                        for (let n of (s.length && (s = []),
                        sR(i, s, t.from),
                        o))
            ...
            updateGutters(t) {
                ...
                if (e == i)
                    ...
                    for (let s of i) {
                        let i = e.indexOf(s);
                        i < 0 ? o.push(new sB(this.view,s)) : (this.gutters[i].update(t),
                        o.push(this.gutters[i]))
                    }
                    for (let t of this.gutters)
                        t.dom.remove(),
                        0 > o.indexOf(t) && t.destroy();
                    for (let t of o)
        ...
        , {
            provide: t=>ir.scrollMargins.of(e=>{
                let i = e.plugin(t);
                return i && 0 != i.gutters.length && i.fixed ? e.textDirection == tF.LTR ? {
        ...
        class sE {
            ...
            line(t, e, i) {
                let s = [];
                sR(this.cursor, s, e.from),
                i.length && (s = s.concat(i));
                let o = this.gutter.config.lineMarker(t, e, s);
                o && s.unshift(o);
                let n = this.gutter;
                if (0 == s.length && !n.config.renderEmptyElements)
                    return;
                let r = e.top - this.height;
                if (this.i == n.elements.length) {
                    let i = new sL(t,e.height,r,s);
                    n.elements.push(i),
                    n.dom.appendChild(i.dom)
                } else
                    n.elements[this.i].update(t, e.height, r, s);
        ...
        class sB {
            constructor(t, e) {
                ...
                this.markers = sO(e.markers(t)),
                e.initialSpacer && (this.spacer = new sL(t,0,0,[e.initialSpacer(t)]),
                this.dom.appendChild(this.spacer.dom),
                this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none")
            }
            update(t) {
                let e = this.markers;
                if (this.markers = sO(this.config.markers(t.view)),
        ...
        class sL {
            ...
            setMarkers(t, e) {
                ...
                for (let o = 0, n = 0; ; ) {
                    ...
                    if (!l)
                        break;
                    l.toDOM && (h ? s = s.nextSibling : this.dom.insertBefore(l.toDOM(t), s)),
                    h && n++
                }
        ...
        function sN(t, e) {
            return t.state.facet(sV).formatNumber(e, t.state)
        }
        let sW = sk.compute([sV], t=>({
            class: "cm-lineNumbers",
            renderEmptyElements: !1,
            markers: t=>t.state.facet(sH),
            lineMarker: (t,e,i)=>i.some(t=>t.toDOM) ? null : new sP(sN(t, t.state.doc.lineAt(e.from).number)),
            lineMarkerChange: t=>t.startState.facet(sV) != t.state.facet(sV),
            initialSpacer: t=>new sP(sN(t, sF(t.state.doc.lines))),
            updateSpacer(t, e) {
                let i = sN(e.view, sF(e.view.state.doc.lines));
                return i == t.number ? t : new sP(i)
            },
            domEventHandlers: t.facet(sV).domEventHandlers
        }));
        function sz(t={}) {
            return [sV.of(t), sA(), sW]
        }
        function sF(t) {
            let e = 9;
            for (; e < t; )
